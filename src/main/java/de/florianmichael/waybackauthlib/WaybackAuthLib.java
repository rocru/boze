...
public class WaybackAuthLib {
    ...
    public WaybackAuthLib(String authHost, String clientToken, Proxy proxy) {
        if (authHost == null) {
            ...
            if (clientToken == null) {
                ...
                this.field1822 = MinecraftClient.unauthenticated(Objects.requireNonNullElse(proxy, Proxy.NO_PROXY));
            }
        }
    }
    ...
    public void method924() throws Exception {
        if (this.field1823 != null && !this.field1823.isEmpty()) {
            ...
            if (!var4 && !var5) {
                ...
                AuthenticateRefreshResponse var6;
                if (var4) {
                    var6 = this.field1822
                            .post(this.field1820.resolve("refresh").toURL(), new RefreshRequest(this.field1821, this.field1825, null), AuthenticateRefreshResponse.class);
                } else {
                    var6 = this.field1822
                            .post(
                                    this.field1820.resolve("authenticate").toURL(),
                                    new AuthenticationRequest(Agent.field1, this.field1823, this.field1824, this.field1821),
    ...
    public boolean method925() {
        ValidateRequest var3 = new ValidateRequest(this.field1825, this.field1821);

        try {
            this.field1822.post(this.field1820.resolve("validate").toURL(), var3, Response.class);
            return true;
    ...
    public void method926() throws Exception {
        InvalidateRequest var4 = new InvalidateRequest(this.field1821, this.field1825);
        Response var5 = this.field1822.post(this.field1820.resolve("invalidate").toURL(), var4, Response.class);
        if (!this.field1827) {
