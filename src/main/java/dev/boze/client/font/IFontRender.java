...
public interface IFontRender {
   static IFontRender method499() {
      return (IFontRender)(FontManager.method1106() ? FontManager.method1105() : FontManager.method1102());
   }

   static IFontRender method500(boolean custom) {
      return (IFontRender)(custom ? FontManager.method1102() : FontRenderer.field1075);
   }
