...
public class FontRenderer implements IFontRender, IMinecraft {
   ...
   private final Class3064<FontRenderContext> field1076 = new Class3064<FontRenderContext>(this::lambda$new$0);
   ...
   public double drawText(String text, double x, double y, ColorWrapper choice) {
      ...
      x += 0.5 * var11;
      y += 0.5 * var11;
      double var13 = (double)mc.textRenderer.getWidth(text);
      ...
      if (!this.field1086) {
         ...
         if (!this.field1090.isEmpty()) {
            for (Class3061 var12 : this.field1090) {
               FontRenderContext var15 = (FontRenderContext)this.field1077.computeIfAbsent(var12.field152.hashCode(), this::lambda$end$1);
            ...
            Iterator var11 = this.field1077.entrySet().iterator();

            while (var11.hasNext()) {
               Entry var13 = (Entry)var11.next();
               BozeDrawColor var16 = ((FontRenderContext)var13.getValue()).field1972;
               this.field1082.method1156(false, true);
               ((FontRenderContext)var13.getValue()).field1971.draw();
               mc.getFramebuffer().beginWrite(false);
               ShaderProgram var18 = ShaderRegistry.field2269;
               var18.method2142();
               ShaderRegistry.field2269.method581("u_Size", (double)mc.getWindow().getFramebufferWidth(), (double)mc.getWindow().getFramebufferHeight());
               var18.method690("u_Src_Texture", 0);
               var18.method693(
                  "u_Fill",
                  (double)((float)var16.field408 / 255.0F),
                  (double)((float)var16.field409 / 255.0F),
                  (double)((float)var16.field410 / 255.0F),
                  (double)((float)var16.field411 / 255.0F)
               );
               ...
               var18.method1416();
               this.field1076.method5994((FontRenderContext)var13.getValue());
               var11.remove();
            }
   ...
   private void method505(float var1, float var2) {
      ...
      ShaderRegistry.field2260.method581("u_Size", (double)mc.getWindow().getFramebufferWidth(), (double)mc.getWindow().getFramebufferHeight());
   ...
   private FontRenderContext lambda$end$1(Class3061 var1, Integer var2) {
      return this.field1076.method5993().method1108(var1.field152);
   }

   private FontRenderContext lambda$new$0() {
      return new FontRenderContext(this);
   }
}
