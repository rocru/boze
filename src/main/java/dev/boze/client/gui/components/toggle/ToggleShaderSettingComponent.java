...
class ToggleShaderSettingComponent extends ToggleComponent {
   final ShaderSettingComponent field1222;

   ToggleShaderSettingComponent(ShaderSettingComponent var1, String var2, double var3, double var5, double var7, double var9) {
