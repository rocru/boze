...
public class fI extends RotationComponent {
    final StaticColor field1208;
    final NewColorComponent field1209;

    public fI(NewColorComponent var1, String var2, double var3, double var5, double var7, double var9, StaticColor var11) {
