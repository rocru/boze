...
class eX extends TextBaseComponent {
   final String field1192;
   final ScaledBaseComponent field1193;
   final AddColorComponent field1194;

   eX(AddColorComponent var1, String var2, double var3, double var5, double var7, double var9, String var11, ScaledBaseComponent var12) {
