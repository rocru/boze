...
public class CurrentProfileSettingComponent extends BottomRowScaledComponent {
   ...
   protected boolean handleItemClick(int index, int button, double itemX, double itemY, double itemWidth, double itemHeight, double mouseX, double mouseY) {
      String var18 = (String)this.field1465.get(index);
   ...
   private boolean method1701(String var1) {
      if (var1.equals(this.field1463.getValue())) {
         ...
         this.field1463.field968.remove(var1);
         BozeExecutor.method2200(CurrentProfileSettingComponent::lambda$deleteProfile$0);
         return true;
      }
   }
   ...
   private void method1800(String var1) {
      ...
      BozeExecutor.method2200(this::lambda$shareProfile$1);
   }
