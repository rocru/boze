...
public class fe extends TextBaseComponent {
    final StaticColor field1181;
    final NewColorComponent field1182;

    public fe(NewColorComponent var1, String var2, double var3, double var5, double var7, double var9, StaticColor var11) {
