...
public class f8 extends IntSliderComponent {
    final StaticColor field2027;
    final NewColorComponent field2028;

    public f8(NewColorComponent var1, String var2, double var3, double var5, double var7, double var9, StaticColor var11) {
