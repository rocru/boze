...
public class BindComponent extends ScaledBaseComponent {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        for (int var8 = 0; var8 < Math.min(this.field1491.field1051.size(), 12); var8++) {
            ...
            IFontRender.method499()
                    .drawShadowedText(
                            this.field1491.field1051.get(var8 + this.field1497),
        ...
        if (isMouseWithinBounds(mouseX, mouseY, this.field1499, this.field1500, this.field1501, this.field1502)) {
            ClickGUI.field1335.field1337 = CursorType.IBeam;
        }
    ...
    public boolean onMouseScroll(double mouseX, double mouseY, double amount) {
        if (isMouseWithinBounds(
            ...
            this.field1497 = (int) MathHelper.clamp(
                    (double) this.field1497 - amount, 0.0, MathHelper.clamp(this.field1491.field1051.size() - 12, 0, this.field1491.field1051.size())
            );
            return true;
        } else {
