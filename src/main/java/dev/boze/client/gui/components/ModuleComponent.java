...
import dev.boze.client.gui.components.setting.AccountSettingComponent;
import dev.boze.client.gui.components.setting.BindSettingComponent;
import dev.boze.client.gui.components.setting.BooleanSettingComponent;
import dev.boze.client.gui.components.setting.ColorSettingComponent;
import dev.boze.client.gui.components.setting.CurrentProfileSettingComponent;
import dev.boze.client.gui.components.setting.EnumSettingComponent;
import dev.boze.client.gui.components.setting.FloatSettingComponent;
import dev.boze.client.gui.components.setting.FontSettingComponent;
import dev.boze.client.gui.components.setting.FriendsSettingComponent;
import dev.boze.client.gui.components.setting.IntArraySettingComponent;
import dev.boze.client.gui.components.setting.IntSettingComponent;
import dev.boze.client.gui.components.setting.ListSettingComponent;
import dev.boze.client.gui.components.setting.MacroSettingComponent;
import dev.boze.client.gui.components.setting.MinMaxDoubleSettingComponent;
import dev.boze.client.gui.components.setting.MinMaxSettingComponent;
import dev.boze.client.gui.components.setting.ProfileSettingComponent;
import dev.boze.client.gui.components.setting.RGBASettingComponent;
import dev.boze.client.gui.components.setting.SettingBlockComponent;
import dev.boze.client.gui.components.setting.SettingCategoryComponent;
import dev.boze.client.gui.components.setting.scaled.MacroManagerSettingComponent;
import dev.boze.client.gui.components.setting.scaled.ShaderSettingComponent;
import dev.boze.client.gui.components.setting.scaled.SoundStringSettingComponent;
import dev.boze.client.gui.components.setting.scaled.StringSettingComponent;
import dev.boze.client.gui.components.setting.scaled.WeirdColorSettingComponent;
import dev.boze.client.gui.notification.Notifications;
import dev.boze.client.gui.screens.ClickGUI;
import dev.boze.client.instances.impl.ChatInstance;
import dev.boze.client.jumptable.hS;
...
public class ModuleComponent extends BaseComponent implements IMinecraft {
   ...
   private Timer field340 = new Timer();
   private double field341;
   private double field342;
   SettingBlock field343 = null;
   ...
   public ModuleComponent(Module module, BaseComponent parent, double x, double y, double width) {
      ...
      if (module.getNotificationLength() != NotificationLength.Popup) {
         ...
         if (module.getNotificationLength() == NotificationLength.Normal) {
            this.field337[0] = new Class2774(Notifications.POWER, ModuleComponent::lambda$new$0, Theme.INSTANCE.field2435);
            this.field337[1] = new Class2774(Notifications.TUNE, ModuleComponent::lambda$new$1, Theme.INSTANCE.field2436);
         }

         if (module != Profiles.INSTANCE && module != Fonts.INSTANCE) {
            this.field337[2] = new Class2774(Notifications.VIEW_LIST, ModuleComponent::lambda$new$2, Theme.INSTANCE.aa);
         }
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      if (!isMouseWithinBounds((double)mouseX, (double)mouseY, this.field318, this.field319, this.field320, this.field335)
         || Math.abs((double)mouseX - this.field341) > this.field320 / 4.0) {
         this.field340.reset();
      }

      this.field341 = (double)mouseX;
      this.field342 = (double)mouseY;
      String var8 = Theme.method1392(Theme.method1369(), this.field334.getName());

      double var9 = switch (hS.field2103[Theme.method1368().ordinal()]) {
      ...
      if (this.field334.getNotificationLength() == NotificationLength.Popup) {
         ...
         if (Theme.method1370() == ModuleDisplayMode.Icons
            && (!Theme.method1372() || isMouseWithinBounds((double)mouseX, (double)mouseY, this.field318, this.field319, this.field320, this.field335))) {
            ...
            boolean var50 = isMouseWithinBounds((double)mouseX, (double)mouseY, var41, var47, var28, var28);
            Notifications.POPUP
               .render(
                  var41,
                  var47,
         ...
         if (Theme.method1372() && !isMouseWithinBounds((double)mouseX, (double)mouseY, this.field318, this.field319, this.field320, this.field335)) {
            ...
            for (Class2774 var23 : this.field337) {
               if (var23 != null && var23.method5428()) {
                  ...
                  var23.field85 = var11;
                  var42 += var11 + var13;
                  boolean var24 = isMouseWithinBounds((double)mouseX, (double)mouseY, var23.field83, var23.field84, var23.field85, var23.field85);
                  var23.field80
                     .render(
                        var23.field83,
                        var23.field84,
            ...
            if (isMouseWithinBounds((double)mouseX, (double)mouseY, this.field344, this.field345, this.field346, this.field347)) {
         ...
         if (this.field338) {
            ...
            if (isMouseWithinBounds((double)mouseX, (double)mouseY, this.field318, this.field319, this.field320, this.field335)
               ...
               for (Class2774 var46 : this.field337) {
                  if (var46 != null
                     && var46.method5428()
                     && isMouseWithinBounds((double)mouseX, (double)mouseY, var46.field83, var46.field84, var46.field85, var46.field85)) {
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int button) {
      if (this.field334.getNotificationLength() == NotificationLength.Popup) {
         if (isMouseWithinBounds(mouseX, mouseY, this.field318, this.field319, this.field320, this.field335)) {
            ScaledBaseComponent var15 = (ScaledBaseComponent)this.field334.method218().get();
            if (var15 != null) {
         ...
         if (this.field338) {
            for (BaseComponent var10 : this.field336) {
               if (var10 instanceof ScaledSettingBaseComponent
                  && (!(var10 instanceof dev.boze.client.gui.components.setting.BindComponent) || Theme.method1370() != ModuleDisplayMode.Bind)) {
                  ScaledSettingBaseComponent var11 = (ScaledSettingBaseComponent)var10;
                  if (this.field343 == null) {
                     ...
                     if (!(var13 instanceof SettingBlock)) {
                        continue;
                     }
   ...
   public boolean method2116() {
      return !Options.INSTANCE.method1971() ? true : this.field334.field435 || this.field334.method221() != null;
   }
