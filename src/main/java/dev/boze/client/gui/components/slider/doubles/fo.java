...
public class fo extends DoubleSliderComponent {
    final ColorSetting field2000;
    final ColorSettingComponent field2001;

    public fo(ColorSettingComponent var1, String var2, double var3, double var5, double var7, double var9, ColorSetting var11) {
