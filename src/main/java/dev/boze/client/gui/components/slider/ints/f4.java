...
public class f4 extends IntSliderComponent {
    final ColorSetting field2019;
    final ColorSettingComponent field2020;

    public f4(ColorSettingComponent var1, String var2, double var3, double var5, double var7, double var9, ColorSetting var11) {
