...
public class IntSettingComponent extends ScaledSettingBaseComponent implements IMinecraft {
        ...
        if (isMouseWithinBounds(mouseX, mouseY, this.field318, this.field319, this.field320, this.field321) && this.field304.method2116()) {
            ...
            if (button == 0) {
                if (isMouseWithinBounds(
                    ...
                    var11 *= this.field304.max - this.field304.min;
                    var11 += this.field304.min;
                    this.field304.setValue((int) var11);
                    ...
                    this.field304.setValue(MathHelper.clamp(this.field304.getValue() - this.field304.step, this.field304.min, this.field304.max));
    ...
    public boolean onDrag(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
        if (button == 0
            ...
            var15 *= this.field304.max - this.field304.min;
            var15 += this.field304.min;
            this.field304.setValue((int) var15);
            this.field273.reset();
            return true;
        } else {
