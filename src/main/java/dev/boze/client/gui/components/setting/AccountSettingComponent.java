...
public class AccountSettingComponent extends ScaledSettingBaseComponent implements IMinecraft {
   private final AccountSetting field1995;

   public AccountSettingComponent(AccountSetting setting, BaseComponent parent, double x, double y, double width, double height) {
      super(setting, parent, x, y, width, height);
      this.field1995 = setting;
   }

   @Override
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      if (this.field1995.method2116()) {
         ...
         if (mc.getSession() != null && mc.getSession().getUsername() != null) {
            IFontRender.method499()
               .drawShadowedText(
                  ...
                  this.field318 + this.field320 - scaleFactor * 21.0 - var8 - IFontRender.method499().method501(mc.getSession().getUsername()),
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int button) {
      if (this.field1995.method2116() && isMouseWithinBounds(mouseX, mouseY, this.field318, this.field319, this.field320, this.field321)) {
         if (button == 0) {
            mc.getSoundManager().play(PositionedSoundInstance.master(SoundEvents.UI_BUTTON_CLICK, 1.0F));
            ClickGUI.field1335.method580(new AccountManagerComponent(this.field1995));
            return true;
         }

         if (button == 1 && this.field1995.hasChildren()) {
            this.field1995.setExpanded(!this.field1995.isExpanded());
            return true;
         }
      }
