...
class ToggleEditGradientColorComponent extends ToggleComponent {
   final GradientColor field2051;
   final EditGradientColorComponent field2052;

   ToggleEditGradientColorComponent(EditGradientColorComponent var1, String var2, double var3, double var5, double var7, double var9, GradientColor var11) {
