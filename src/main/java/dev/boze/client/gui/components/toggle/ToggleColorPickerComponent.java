...
class ToggleColorPickerComponent extends ToggleComponent {
   final ChangingColor field2047;
   final ColorPickerComponent field2048;

   ToggleColorPickerComponent(ColorPickerComponent var1, String var2, double var3, double var5, double var7, double var9, ChangingColor var11) {
