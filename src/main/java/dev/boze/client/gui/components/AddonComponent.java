...
public class AddonComponent extends BaseComponent implements IMinecraft {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        this.field369 = mouseX;
        this.field370 = mouseY;
        ...
        if (Theme.method1372() && !isMouseWithinBounds(mouseX, mouseY, this.field318, this.field319, this.field320, this.field363)) {
            ...
            if (isMouseWithinBounds(mouseX, mouseY, this.field318, this.field319, this.field320, this.field363)) {
                ...
                for (Class2773 var23 : this.field365) {
                    if (var23.method5427()) {
                        ...
                        var23.field79 = var11;
                        var33 += var11 + var13;
                        boolean var24 = isMouseWithinBounds(mouseX, mouseY, var23.field77, var23.field78, var23.field79, var23.field79);
                        var23.field74
                                .render(
                                        var23.field77,
                                        var23.field78,
            ...
            if (isMouseWithinBounds(mouseX, mouseY, this.field371, this.field372, this.field373, this.field374)) {
        ...
        if (this.field366) {
            ...
            for (int var29 = 0; var29 < this.field364.size(); var29++) {
                BaseComponent var31 = this.field364.get(var29);
                if (var31 instanceof SettingBaseComponent var32
                        && (
