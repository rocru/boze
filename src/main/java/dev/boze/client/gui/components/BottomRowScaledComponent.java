...
public abstract class BottomRowScaledComponent extends ScaledBaseComponent {
    ...
    public BottomRowScaledComponent(String name, BottomRow bottomRow, double widthRatio, double heightRatio, int extraComponents) {
        ...
        double var13 = extraComponents > 0
                ...
                : 0.0;
        this.field1390 = Math.min(widthRatio * 1280.0 * BaseComponent.scaleFactor, mc.getWindow().getScaledWidth());
        this.field1391 = Math.min(var11 + var13, mc.getWindow().getScaledHeight());
    ...
    public void method635(Runnable callback) {
    ...
    public boolean onMouseScroll(double mouseX, double mouseY, double amount) {
        if (isMouseWithinBounds(
            ...
            this.field1422 = (int) MathHelper.clamp((double) this.field1422 - amount, 0.0, MathHelper.clamp(this.method2010() - 12, 0, this.method2010()));
            return true;
        } else {
