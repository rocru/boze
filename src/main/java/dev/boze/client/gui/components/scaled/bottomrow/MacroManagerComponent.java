...
public class MacroManagerComponent extends BottomRowScaledComponent {
   ...
   protected void method639(DrawContext context, int index, double itemX, double itemY, double itemWidth, double itemHeight) {
      String var10000 = ((Macro)this.field1451.get(index)).field1049.isKey()
         ? KeyboardUtil.getKeyName(((Macro)this.field1451.get(index)).field1049.getBind())
         : KeyboardUtil.getButtonName(((Macro)this.field1451.get(index)).field1049.getBind());
      String var10001 = ((Macro)this.field1451.get(index)).field1048;
      String var15 = ((Macro)this.field1451.get(index)).field1050 ? "Active" : "Inactive";
   ...
   protected boolean handleItemClick(int index, int button, double itemX, double itemY, double itemWidth, double itemHeight, double mouseX, double mouseY) {
      ...
      if (isMouseWithinBounds(mouseX, mouseY, var18, var20, Notifications.DELETE.method2091(), IconManager.method1116())) {
         ...
         ClickGUI.field1335.method580(new BindComponent((Macro)this.field1451.get(index), this.field1449));
         mc.getSoundManager().play(PositionedSoundInstance.master(SoundEvents.UI_BUTTON_CLICK, 1.0F));
         return true;
      } else {
         if (mc.player != null) {
            for (String var25 : ((Macro)this.field1451.get(index)).field1051) {
