...
public class f9 extends IntSliderComponent {
    final StaticColor field2029;
    final NewColorComponent field2030;

    public f9(NewColorComponent var1, String var2, double var3, double var5, double var7, double var9, StaticColor var11) {
