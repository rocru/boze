...
public class ToggleColorSettingComponent extends ToggleComponent {
    final ColorSetting field2049;
    final ColorSettingComponent field2050;

    public ToggleColorSettingComponent(ColorSettingComponent var1, String var2, double var3, double var5, double var7, double var9, ColorSetting var11) {
