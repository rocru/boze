...
class fu extends FloatSliderComponent {
   final GradientColor field1149;
   final EditGradientColorComponent field1150;

   fu(EditGradientColorComponent var1, String var2, double var3, double var5, double var7, double var9, GradientColor var11) {
