...
import dev.boze.client.gui.components.scaled.bottomrow.SoundSettingComponent;
...
public class SoundStringSettingComponent extends ScaledSettingBaseComponent implements IMinecraft {
   private final SoundStringSetting field1997;

   public SoundStringSettingComponent(SoundStringSetting setting, BaseComponent parent, double x, double y, double width, double height) {
      super(setting, parent, x, y, width, height);
      this.field1997 = setting;
   }

   @Override
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      if (this.field1997.method2116()) {
         ...
         if (!this.field1997.method1322().isEmpty()) {
            IFontRender.method499()
               .drawShadowedText(
                  this.field1997.method1322(),
                  this.field318 + this.field320 - scaleFactor * 21.0 - var8 - IFontRender.method499().method501(this.field1997.method1322()),
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int button) {
      if (this.field1997.method2116() && isMouseWithinBounds(mouseX, mouseY, this.field318, this.field319, this.field320, this.field321)) {
         if (button == 0) {
            mc.getSoundManager().play(PositionedSoundInstance.master(SoundEvents.UI_BUTTON_CLICK, 1.0F));
            ClickGUI.field1335.method580(new SoundSettingComponent(this.field1997));
            return true;
         }

         if (button == 1 && this.field1997.hasChildren()) {
            this.field1997.setExpanded(!this.field1997.isExpanded());
            return true;
         }
      }
