...
public class SoundStringSettingComponent extends ScaledSettingBaseComponent implements IMinecraft {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      if (this.field1997.method2116()) {
         ...
         if (!this.field1997.getValue().isEmpty()) {
            IFontRender.method499()
               .drawShadowedText(
                  this.field1997.getValue(),
                  this.field318 + this.field320 - scaleFactor * 21.0 - var8 - IFontRender.method499().method501(this.field1997.getValue()),
