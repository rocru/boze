...
public class fd extends TextBaseComponent {
    final StaticColor field1179;
    final NewColorComponent field1180;

    public fd(NewColorComponent var1, String var2, double var3, double var5, double var7, double var9, StaticColor var11) {
