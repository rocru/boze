...
class fv extends FloatSliderComponent {
   final GradientColor field1151;
   final EditGradientColorComponent field1152;

   fv(EditGradientColorComponent var1, String var2, double var3, double var5, double var7, double var9, GradientColor var11) {
