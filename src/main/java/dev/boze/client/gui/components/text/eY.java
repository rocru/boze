...
public class eY extends TextBaseComponent {
    final String field1195;
    final ScaledBaseComponent field1196;
    final AddColorComponent field1197;

    public eY(AddColorComponent var1, String var2, double var3, double var5, double var7, double var9, String var11, ScaledBaseComponent var12) {
