...
class ToggleColorPickerChangingComponent extends ToggleComponent {
   final ChangingColor field2045;
   final ColorPickerComponent field2046;

   ToggleColorPickerChangingComponent(ColorPickerComponent var1, String var2, double var3, double var5, double var7, double var9, ChangingColor var11) {
