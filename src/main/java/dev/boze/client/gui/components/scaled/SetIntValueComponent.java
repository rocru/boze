...
public class SetIntValueComponent extends ScaledBaseComponent {
   ...
   private String field1395;

   public SetIntValueComponent(IntSetting setting) {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      String var10 = this.field1395 + (System.currentTimeMillis() % 1500L < 750L ? "|" : "");
      RenderUtil.field3963
         .method2257(
   ...
   public boolean isMouseOver(double mouseX, double mouseY, int button) {
      if (isMouseWithinBounds(mouseX, mouseY, this.field1388, this.field1389, this.field1390, this.field1391)) {
         ...
         if (isMouseWithinBounds(
            ...
            && this.field1395.length() > 0) {
            try {
               this.field1394.method436(MathHelper.clamp(Integer.parseInt(this.field1395), this.field1394.min, this.field1394.max));
               mc.getSoundManager().play(PositionedSoundInstance.master(SoundEvents.UI_BUTTON_CLICK, 1.0F));
   ...
   public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
      try {
         if (keyCode == 259) {
            this.field1395 = this.field1395.substring(0, this.field1395.length() - 1);
         } else if (keyCode == 257 && this.field1395.length() > 0) {
            try {
               this.field1394.method436(MathHelper.clamp(Integer.parseInt(this.field1395), this.field1394.min, this.field1394.max));
               mc.getSoundManager().play(PositionedSoundInstance.master(SoundEvents.UI_BUTTON_CLICK, 1.0F));
   ...
   public void method583(char c) {
      try {
         if (c >= '0' && c <= '9') {
            this.field1395 = this.field1395 + c;
         }
