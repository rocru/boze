...
public class fw extends FloatSliderComponent {
    final GradientColor field1153;
    final EditGradientColorComponent field1154;

    public fw(EditGradientColorComponent var1, String var2, double var3, double var5, double var7, double var9, GradientColor var11) {
