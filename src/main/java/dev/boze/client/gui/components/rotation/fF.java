...
public class fF extends RotationComponent {
    ...
    public fF(ColorSettingComponent var1, String var2, double var3, double var5, double var7, double var9, ColorSetting var11) {
    ...
    protected void method938(double value) {
        ...
        int[] var4 = RGBAColor.method190(value * 360.0, var3[1], var3[2]);
    ...
    protected void method2142() {
        ...
        int[] var3 = RGBAColor.method190(var2[0], var1[1], var1[2]);
