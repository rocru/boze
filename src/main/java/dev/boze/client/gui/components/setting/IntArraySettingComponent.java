...
public class IntArraySettingComponent extends ScaledSettingBaseComponent implements IMinecraft {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        if (this.field287.method2116()) {
            ...
            String var9 = var17.format(this.field287.getValue()[this.field287.method1365()]);
            if ((double) this.field287.getValue()[this.field287.method1365()] >= 0.0 && var9.startsWith("-")) {
                var9 = var9.substring(1);
            }

            String var18 = var17.format(this.field287.getValue()[this.field287.method1366()]);
        ...
        if (isMouseWithinBounds(mouseX, mouseY, this.field318, this.field319, this.field320, this.field321) && this.field287.method2116()) {
            ...
            if (button == 0) {
                if (isMouseWithinBounds(
                    ...
                    double var13 = this.field287.field921 - this.field287.field920;
    ...
    public boolean onDrag(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
        if (button == 0
            ...
            if (this.field288 == -2) {
                ...
                var13 *= this.field287.field921 - this.field287.field920;
                ...
                var15 *= this.field287.field921 - this.field287.field920;
                var15 += this.field287.field920;
