...
import dev.boze.client.jumptable.hQ;
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      if (!this.field375.extended && System.currentTimeMillis() - this.field382 >= (long)Gui.INSTANCE.field2370.method434().intValue()) {
         ...
         for (int var24 = 0; var24 < this.field378.size(); var24++) {
            BaseComponent var26 = (BaseComponent)this.field378.get(var24);
      ...
      double var22 = switch (hQ.field2101[Theme.method1358().ordinal()]) {
         case 1 -> this.field318 + scaleFactor * 6.0;
         case 2 -> this.field318 + this.field320 / 2.0 - var21 / 2.0;
         case 3 -> this.field318 + this.field320 - scaleFactor * 6.0 - var21;
