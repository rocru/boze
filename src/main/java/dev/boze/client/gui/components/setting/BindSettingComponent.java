...
public class BindSettingComponent extends ScaledSettingBaseComponent implements IMinecraft {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      if (this.field269.method2116()) {
         ...
         if (this.field270) {
            var17 = "...";
         } else if (this.field269.method476().getBind() == -1) {
            var17 = " ";
         } else {
            var17 = this.field269.method476().isKey()
               ? KeyboardUtil.getKeyName(this.field269.method476().getBind())
               : KeyboardUtil.getButtonName(this.field269.method476().getBind());
         }

         double var11 = this.field269.method476().getBind() == -1
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int button) {
      if (this.field269.method2116() && isMouseWithinBounds(mouseX, mouseY, this.field318, this.field319, this.field320, this.field321)) {
         if (this.field270) {
            this.field269.method476().set(false, button);
            this.field270 = false;
