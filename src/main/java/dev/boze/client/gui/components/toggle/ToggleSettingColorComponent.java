...
class ToggleSettingColorComponent extends ToggleComponent {
   final SettingColorComponent field2057;

   ToggleSettingColorComponent(SettingColorComponent var1, String var2, double var3, double var5, double var7, double var9) {
