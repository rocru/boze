...
public class e_ extends TextBaseComponent {
    final ColorSetting field1199;
    final ColorSettingComponent field1200;

    public e_(ColorSettingComponent var1, String var2, double var3, double var5, double var7, double var9, ColorSetting var11) {
    ...
    protected void method1649(int button) {
        if (button == 0) {
            ...
            ColorSettingComponent.field1396 = this.field1199.method1374().copy();
        }
    }
}
