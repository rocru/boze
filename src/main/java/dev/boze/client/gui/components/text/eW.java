...
class eW extends TextBaseComponent {
   final String field1189;
   final ScaledBaseComponent field1190;
   final AddColorComponent field1191;

   eW(AddColorComponent var1, String var2, double var3, double var5, double var7, double var9, String var11, ScaledBaseComponent var12) {
