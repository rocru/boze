...
class ft extends FloatSliderComponent {
   final WeirdColorSetting field1147;
   final WeirdColorSettingComponent field1148;

   ft(WeirdColorSettingComponent var1, String var2, double var3, double var5, double var7, double var9, WeirdColorSetting var11) {
