...
public class ToggleEditGradientComponent extends ToggleComponent {
    final GradientColor field2053;
    final EditGradientColorComponent field2054;

    public ToggleEditGradientComponent(EditGradientColorComponent var1, String var2, double var3, double var5, double var7, double var9, GradientColor var11) {
