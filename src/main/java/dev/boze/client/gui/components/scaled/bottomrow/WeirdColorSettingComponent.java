...
public class WeirdColorSettingComponent extends BottomRowScaledComponent {
    ...
    private String method1554(int var1) {
        if (!this.field1458.method429(this.field1458.field936)) {
            return this.method1144().get(var1);
        } else {
            return var1 == 0 ? "Default" : this.method1144().get(var1 - 1);
        }
    }

    private Class5903<?> method644(int var1) {
        if (!this.field1458.method429(this.field1458.field936)) {
            return Colors.INSTANCE.field2343.get(this.method1144().get(var1));
        } else {
            return var1 == 0 ? this.field1458.field936 : Colors.INSTANCE.field2343.get(this.method1144().get(var1 - 1));
        }
    }
    ...
    public boolean isMouseOver(double mouseX, double mouseY, int button) {
        if (this.field1459.mouseClicked(mouseX, mouseY, button)) {
            ...
            return !this.field1458.opacity && this.field1460.mouseClicked(mouseX, mouseY, button) || super.isMouseOver(mouseX, mouseY, button);
        }
    }
    ...
    public boolean onDrag(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
        if (this.field1459.onDrag(mouseX, mouseY, button, deltaX, deltaY)) {
            ...
            return !this.field1458.opacity && this.field1460.onDrag(mouseX, mouseY, button, deltaX, deltaY) || super.onDrag(mouseX, mouseY, button, deltaX, deltaY);
        }
    }
