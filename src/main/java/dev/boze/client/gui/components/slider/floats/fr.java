...
public class fr extends FloatSliderComponent {
    final ChangingColor field1143;
    final ColorPickerComponent field1144;

    public fr(ColorPickerComponent var1, String var2, double var3, double var5, double var7, double var9, ChangingColor var11) {
