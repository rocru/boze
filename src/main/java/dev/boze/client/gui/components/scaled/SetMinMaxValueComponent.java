...
public class SetMinMaxValueComponent extends ScaledBaseComponent {
   private final MinMaxSetting field1468;
   private String field1469;

   public SetMinMaxValueComponent(MinMaxSetting setting) {
      super(setting.name, 0.2, 0.2);
      this.field1468 = setting;
      DecimalFormat var4 = new DecimalFormat("#.###");
      this.field1469 = var4.format(setting.getValue());
   }
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      String var10 = this.field1469 + (System.currentTimeMillis() % 1500L < 750L ? "|" : "");
      RenderUtil.field3963
         .method2257(
   ...
   public boolean isMouseOver(double mouseX, double mouseY, int button) {
      if (isMouseWithinBounds(mouseX, mouseY, this.field1388, this.field1389, this.field1390, this.field1391)) {
         ...
         if (isMouseWithinBounds(
            ...
            && this.field1469.length() > 0) {
            try {
               this.field1468.setValue(MathHelper.clamp(Double.parseDouble(this.field1469), this.field1468.field942, this.field1468.field943));
               mc.getSoundManager().play(PositionedSoundInstance.master(SoundEvents.UI_BUTTON_CLICK, 1.0F));
   ...
   public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
      try {
         if (keyCode == 259) {
            this.field1469 = this.field1469.substring(0, this.field1469.length() - 1);
         } else if (keyCode == 257 && this.field1469.length() > 0) {
            try {
               this.field1468.setValue(MathHelper.clamp(Double.parseDouble(this.field1469), this.field1468.field942, this.field1468.field943));
               mc.getSoundManager().play(PositionedSoundInstance.master(SoundEvents.UI_BUTTON_CLICK, 1.0F));
   ...
   public void method583(char c) {
      try {
         if (c >= '0' && c <= '9' || c == '.' && !this.field1469.contains(".")) {
            this.field1469 = this.field1469 + c;
         }
