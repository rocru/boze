...
import dev.boze.client.jumptable.hP;
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      if (!Class2779.field90 && System.currentTimeMillis() - this.field356 >= (long)Gui.INSTANCE.field2370.method434().intValue()) {
         ...
         for (int var21 = 0; var21 < this.field352.size(); var21++) {
            BaseComponent var23 = (BaseComponent)this.field352.get(var21);
      ...
      double var11 = switch (hP.field2100[Theme.method1358().ordinal()]) {
         case 1 -> this.field318 + scaleFactor * 6.0;
         case 2 -> this.field318 + this.field320 / 2.0 - IFontRender.method499().method501(var19) / 2.0;
         case 3 -> this.field318 + this.field320 - scaleFactor * 6.0 - IFontRender.method499().method501(var19);
      ...
      boolean var13 = false;
      if (isMouseWithinBounds((double)mouseX, (double)mouseY, this.field318, this.field319, this.field320, var8)) {
         IconManager.setScale(scaleFactor * 0.4);
