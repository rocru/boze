...
public class fR extends IntSliderComponent {
   final SettingColorComponent field2033;

   public fR(SettingColorComponent var1, String var2, double var3, double var5, double var7, double var9) {
   ...
   protected void method1649(int value) {
      this.field2033.method1362().field409 = value;
   }

   @Override
   protected int method2010() {
      return this.field2033.method1362().field409;
   }
   ...
   protected void method2142() {
      this.field2033.method1362().field409 = 0;
   }
