...
public class CurrentProfileSettingComponent extends ScaledSettingBaseComponent implements IMinecraft {
    private final CurrentProfileSetting field1996;

    public CurrentProfileSettingComponent(CurrentProfileSetting setting, BaseComponent parent, double x, double y, double width, double height) {
        super(setting, parent, x, y, width, height);
        this.field1996 = setting;
    }

    @Override
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        if (this.field1996.method2116()) {
            ...
            if (!this.field1996.getValue().isEmpty()) {
                ...
                IFontRender.method499()
                        .drawShadowedText(
                                var14,
                                this.field318 + this.field320 - scaleFactor * 21.0 - var8 - IFontRender.method499().method501(var14),
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (this.field1996.method2116() && isMouseWithinBounds(mouseX, mouseY, this.field318, this.field319, this.field320, this.field321)) {
            if (button == 0) {
                mc.getSoundManager().play(PositionedSoundInstance.master(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                ClickGUI.field1335.method580(new dev.boze.client.gui.components.scaled.bottomrow.CurrentProfileSettingComponent(this.field1996));
                return true;
            }

            if (button == 1 && this.field1996.hasChildren()) {
                this.field1996.setExpanded(!this.field1996.isExpanded());
                return true;
            }
        }
