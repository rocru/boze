...
public class fs extends FloatSliderComponent {
    final WeirdColorSetting field1145;
    final WeirdColorSettingComponent field1146;

    public fs(WeirdColorSettingComponent var1, String var2, double var3, double var5, double var7, double var9, WeirdColorSetting var11) {
