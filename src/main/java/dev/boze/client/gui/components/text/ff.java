...
public class ff extends TextBaseComponent {
    final ScaledBaseComponent field1183;
    final NewColorComponent field1184;

    public ff(NewColorComponent var1, String var2, double var3, double var5, double var7, double var9, ScaledBaseComponent var11) {
