...
class fg extends TextBaseComponent {
   final Class2775 field1185;
   final StaticColor field1186;
   final ScaledBaseComponent field1187;
   final NewColorComponent field1188;

   fg(NewColorComponent var1, String var2, double var3, double var5, double var7, double var9, Class2775 var11, StaticColor var12, ScaledBaseComponent var13) {
