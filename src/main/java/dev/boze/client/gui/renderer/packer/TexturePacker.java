...
public class TexturePacker implements IMinecraft {
   ...
   public GuiTexture method562(Identifier id) {
      try {
         InputStream var5 = ((Resource)mc.getResourceManager().getResource(id).get()).getInputStream();
         ...
         try {
            ...
            try {
               ...
               TextureRegion var15 = new TextureRegion((double)var13, (double)var14);
   ...
   private void method563(GuiTexture var1, ByteBuffer var2, int var3, int var4, int var5) {
      ...
      TextureRegion var10 = new TextureRegion((double)var5, (double)var8);
