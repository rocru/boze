...
public class ClickGUI extends Screen implements IMinecraft {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (this.field1336) {
            ...
            for (HUDModule var11 : this.field1341) {
                var11.method300(mouseX, mouseY, delta);
            }
        }
        ...
        if (this.field1342 == null) {
            ...
            if (Theme.method1382()) {
                ChamsShaderRenderer.method1312(() -> this.ln0(context), true, Theme.method1383(), Theme.method1386(), Theme.method1384(), Theme.method1385());
            }
            ...
            if (Theme.method1382()) {
                ChamsShaderRenderer.method1312(() -> this.ln1(context), true, Theme.method1383(), Theme.method1386(), Theme.method1384(), Theme.method1385());
            }
        }
    ...
    public boolean method582(BaseComponent element) {
        if (element instanceof ModuleComponent var5) {
            ...
            return !this.field1346.field387.isEmpty() && !var6.field362.getTitle().toLowerCase(Locale.ROOT).contains(this.field1346.field387.toLowerCase(Locale.ROOT))
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        for (int var13 = this.method2120().size() - 1; var13 >= 0; var13--) {
            BaseComponent var14 = this.method2120().get(var13);
        ...
        if (Gui.INSTANCE.field2358.getValue() && this.field1346 != null && this.field1346.mouseClicked(mouseX, mouseY, button)) {
            ...
            return this.field1347 != null && !this.field1336 && this.field1347.mouseClicked(mouseX, mouseY, button) || super.mouseClicked(mouseX, mouseY, button);
        }
    }
    ...
    public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
        if (this.field1342 != null && this.field1342.onDrag(mouseX, mouseY, button, deltaX, deltaY)) {
            ...
            return Gui.INSTANCE.field2358.getValue() && this.field1346 != null && this.field1346.onDrag(mouseX, mouseY, button, deltaX, deltaY) || super.mouseDragged(mouseX, mouseY, button, deltaX, deltaY);
        }
    }
    ...
    public boolean keyReleased(int keyCode, int scanCode, int modifiers) {
        if (this.field1342 != null) {
            this.field1342.onMouseClicked(keyCode, scanCode, modifiers);
        }
    ...
    private void ln1(DrawContext var1) {
        this.field1333.method2235(var1);
    }

    private void ln0(DrawContext var1) {
        this.field1333.method2235(var1);
    }
}
