...
class ShowInArrayListComponent extends ToggleComponent {
   final Module field2088;
   final ModuleComponent field2089;

   ShowInArrayListComponent(ModuleComponent var1, String var2, double var3, double var5, double var7, double var9, Module var11) {
