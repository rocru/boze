...
public class ToggleNotificationsComponent extends ToggleComponent {
   final Module field2090;
   final ModuleComponent field2091;

   public ToggleNotificationsComponent(ModuleComponent var1, String var2, double var3, double var5, double var7, double var9, Module var11) {
