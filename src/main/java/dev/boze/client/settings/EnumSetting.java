...
public class EnumSetting<T extends Enum> extends Setting<T> {
   ...
   public int method464(String input) {
      for (int var5 = 0; var5 < ((Enum[])this.field972.getClass().getEnumConstants()).length; var5++) {
   ...
   public Enum method465(String value) {
      for (Enum var8 : (Enum[])this.field972.getClass().getEnumConstants()) {
