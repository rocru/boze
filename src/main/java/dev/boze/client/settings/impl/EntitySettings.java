...
public class EntitySettings implements SettingsGroup, IMinecraft {
    public final BooleanSetting field92 = new BooleanSetting("Wardens", false, "Don't render wardens");
    public final BooleanSetting field93 = new BooleanSetting(
            "CancelPackets",
            false,
    ...
    public boolean method2055(Entity entity) {
        if (!(entity instanceof WardenEntity)
            ...
            } else return entity instanceof ItemEntity && this.field105.getValue();
    ...
    public boolean method1993(LivingEntity var1, EquipmentSlot var2) {
        return (!(var1 instanceof ArmorStandEntity) || this.field100.getValue()) && (var2 == EquipmentSlot.HEAD && this.field101.getValue()
