...
public class PerformanceSettings implements SettingsGroup {
    ...
    public boolean method1301(Particle particle) {
        return (particle instanceof FireworkParticle || particle instanceof Flash) && this.field2222.getValue() || particle instanceof CampfireSmokeParticle && this.field2223.getValue();
    }
}
