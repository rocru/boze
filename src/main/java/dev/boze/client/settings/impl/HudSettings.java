...
public class HudSettings implements SettingsGroup {
    public final BooleanSetting field2179 = new BooleanSetting("Scoreboard", false, "Don't render scoreboard");
    public final BooleanSetting field2180 = new BooleanSetting("PotionIcons", false, "Don't render potion icons");
    public final BooleanSetting field2181 = new BooleanSetting("BossBar", false, "Don't render boss bars");
    public final BooleanSetting field2182 = new BooleanSetting("HotbarNames", false, "Don't render selected item name above hotbar");
    private final SettingCategory field2183 = new SettingCategory("Overlays", "Options for not rendering overlays");
    public final BooleanSetting field2184 = new BooleanSetting("Portal", true, "Don't render portal overlay", this.field2183);
    ...
    public boolean method1280(RegistryEntry<StatusEffect> var1) {
        return var1 == StatusEffects.BLINDNESS && this.field2191.getValue();
    }

    public void method1281(PlayerOverlayEvent var1) {
