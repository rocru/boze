...
public class MiscSettings implements SettingsGroup {
   final BooleanSetting field2205 = new BooleanSetting("HurtBobbing", true, "Don't render hurt bobbing");
   final BooleanSetting field2206 = new BooleanSetting("InsecureChat", true, "Hide insecure chat warning");
   private final BooleanSetting field2207 = new BooleanSetting("PopSounds", false, "Don't play pop sounds");
   final BooleanSetting field2208 = new BooleanSetting("PopEffect", false, "Don't show pop effect");
   final BooleanSetting field2209 = new BooleanSetting("Maps", false, "Don't render maps");
   final BooleanSetting field2210 = new BooleanSetting("Narrator", false, "Disable narrator");
