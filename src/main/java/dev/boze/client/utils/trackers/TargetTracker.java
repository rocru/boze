...
public class TargetTracker implements IMinecraft {
    ...
    public static PlayerEntity method1520() {
        ...
        for (Entity var7 : method560()) {
            if (var7 instanceof PlayerEntity && field1358.get(var7) > var3) {
                var3 = field1358.get(var7);
            ...
            if (var0.packet instanceof EntityStatusS2CPacket var4 && var4.getStatus() == 35) {
                ...
                try {
                    if (field1359.get(var5.getNameForScoreboard()) == null) {
                        ...
                        field1359.put(var5.getNameForScoreboard(), field1359.get(var5.getNameForScoreboard()) + 1);
                    }

                    Class1204 var6 = new Class1204(var5, field1359.get(var5.getNameForScoreboard()));
