...
public class PeekScreen extends ShulkerBoxScreen implements IMinecraft {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        return button == 2 && this.focusedSlot != null && !this.focusedSlot.getStack().isEmpty() && mc.player.currentScreenHandler.getCursorStack().isEmpty() && method589(this.focusedSlot.getStack(), this.field1356, false);
    }
