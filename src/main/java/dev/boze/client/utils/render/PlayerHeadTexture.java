...
public class PlayerHeadTexture extends Texture implements IMinecraft {
   ...
   public PlayerHeadTexture() {
      try {
         InputStream var4 = ((Resource)mc.getResourceManager().getResource(Identifier.of("boze", "textures/steve.png")).get()).getInputStream();
   ...
   private void method495(ByteBuffer var1) {
      Runnable var5 = this::lambda$upload$0;
