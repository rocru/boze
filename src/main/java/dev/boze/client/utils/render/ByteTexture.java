...
public class ByteTexture extends AbstractTexture {
    public ByteTexture(int width, int height, byte[] data, Format format, Filter filterMin, Filter filterMag) {
        if (!RenderSystem.isOnRenderThread()) {
            RenderSystem.recordRenderCall(() -> this.ln0(width, height, data, format, filterMin, filterMag));
        } else {
    ...
    public ByteTexture(int width, int height, ByteBuffer buffer, Format format, Filter filterMin, Filter filterMag) {
        if (!RenderSystem.isOnRenderThread()) {
            RenderSystem.recordRenderCall(() -> this.ln1(width, height, buffer, format, filterMin, filterMag));
        } else {
    ...
    private void ln1(int var1, int var2, ByteBuffer var3, Format var4, Filter var5, Filter var6) {
        this.method2228(var1, var2, var3, var4, var5, var6);
    }

    private void ln0(int var1, int var2, byte[] var3, Format var4, Filter var5, Filter var6) {
