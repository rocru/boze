...
public class ChangingColor extends Class5903<ChangingColor> {
   ...
   public StaticColor method209(float progress) {
      ...
      for (var7 = 0; var7 < var5; var7++) {
         var6[var7] = (StaticColor)this.field416.get(var7);
      }

      if (this.field418) {
         for (int var8 = var5 - 2; var7 < var6.length; var7++) {
            var6[var7] = (StaticColor)this.field416.get(var8--);
         }
      } else {
         var6[var5] = (StaticColor)this.field416.get(0);
      }

      float var12 = progress * (float)(var6.length - 1);
      int var9 = (int)Math.floor((double)var12);
      int var10 = (int)Math.ceil((double)var12);
      var9 = Math.min(var9, var6.length - 1);
      var10 = Math.min(var10, var6.length - 1);
      float var11 = var12 - (float)var9;
      return this.field417 ? Class3071.method6018(var6[var9], var6[var10], (double)var11) : Class3071.method6017(var6[var9], var6[var10], (double)var11);
   }
   ...
   public StaticColor method208() {
      ...
      for (var10 = 0; var10 < var8; var10++) {
         var9[var10] = (StaticColor)this.field416.get(var10);
      }

      if (this.field418) {
         for (int var11 = var8 - 2; var10 < var9.length; var10++) {
            var9[var10] = (StaticColor)this.field416.get(var11--);
         }
      } else {
         var9[var8] = (StaticColor)this.field416.get(0);
      }

      float var15 = var7 * (float)(var9.length - 1);
      int var12 = (int)Math.floor((double)var15);
      int var13 = (int)Math.ceil((double)var15);
      var12 = Math.min(var12, var9.length - 1);
      var13 = Math.min(var13, var9.length - 1);
      float var14 = var15 - (float)var12;
      return this.field417 ? Class3071.method6018(var9[var12], var9[var13], (double)var14) : Class3071.method6017(var9[var12], var9[var13], (double)var14);
   }
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.field416, this.field417, this.field418, this.field419});
   }
   ...
   public ChangingColor method211(NbtCompound tag) {
