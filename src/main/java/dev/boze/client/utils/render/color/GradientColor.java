...
public class GradientColor extends Class5903<GradientColor> {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.field422, this.field424, this.field426, this.field425, this.field428, this.field429});
   }
   ...
   public GradientColor method213(NbtCompound tag) {
