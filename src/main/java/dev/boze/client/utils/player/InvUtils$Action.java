...
public class InvUtils$Action {
   ...
   private InvUtils$Action() {
   }

   public InvUtils$Action method2206(int id) {
      this.field3952 = id;
      return this;
   }

   public InvUtils$Action method2207(int index) {
      return this.method2206(SlotUtils.method1541(index));
   }

   public InvUtils$Action method2208(int i) {
      return this.method2207(0 + i);
   }

   public InvUtils$Action method2209() {
      return this.method2207(45);
   }

   public InvUtils$Action method2210(int i) {
      return this.method2207(9 + i);
   }

   public InvUtils$Action method2211(int i) {
