...
public class RaycastUtil implements IMinecraft {
    ...
    public static boolean method117(Vec3d var0, Vec3d var1) {
        ...
        return var5.getType() == Type.MISS || var5.getBlockPos().equals(BlockPos.ofFloored(mc.player.getEyePos()));
    }
    ...
    private static BlockHitResult method577(RaycastContext ctx, BlockPos blockPos, boolean bl) {
        return BlockView.raycast(ctx.getStart(), ctx.getEnd(), ctx, (arg_0, arg_1) -> RaycastUtil.lambda$raycast$1(blockPos, bl, arg_0, arg_1), RaycastUtil::lambda$raycast$2);
    }
