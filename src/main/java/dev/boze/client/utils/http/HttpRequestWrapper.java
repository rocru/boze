...
public class HttpRequestWrapper {
   ...
   public InputStream method2186() {
      return this.<InputStream>method2184("*/*", BodyHandlers.ofInputStream());
   }

   public String method2187() {
      return this.<String>method2184("*/*", BodyHandlers.ofString());
   }

   public Stream<String> method2188() {
      return this.<Stream<String>>method2184("*/*", BodyHandlers.ofLines());
   }

   public <T> T method2189(Type type) {
      InputStream var4 = this.<InputStream>method2184("application/json", BodyHandlers.ofInputStream());
      return (T)(var4 == null ? null : HttpUtil.field3946.fromJson(new InputStreamReader(var4), type));
   }
}
