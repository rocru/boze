...
public class SkinUtil {
    ...
    public static String method2194(String username) {
        try {
            ProfileResponse var4 = HttpUtil.get("https://api.mojang.com/users/profiles/minecraft/" + username).method2189(ProfileResponse.class);
            if (var4 == null) {
                ...
                UuidToProfileResponse var5 = HttpUtil.get("https://sessionserver.mojang.com/session/minecraft/profile/" + var4.field3947)
                        .method2189(UuidToProfileResponse.class);
                if (var5 == null) {
                    ...
                    if (var6 == null) {
                        ...
                        TexturesJson var7 = new Gson().fromJson(new String(Base64.getDecoder().decode(var6)), TexturesJson.class);
