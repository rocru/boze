...
public class Macro implements IJsonSerializable<Macro>, IMinecraft {
   ...
   public Macro method491(JsonObject object) {
      this.field1048 = object.get("name").getAsString();
      this.field1049 = this.field1049.method181(object.get("bind").getAsJsonObject());
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.field1048});
   }
