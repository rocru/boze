...
public class NotificationManager {
    ...
    private static final ConcurrentHashMap<INotification, Long> field2142 = new ConcurrentHashMap();
    ...
    public static void method1152() {
        if (field2142.size() < 5 && !field2141.isEmpty()) {
            field2142.put(field2141.pop(), System.currentTimeMillis());
        }

        double var3 = 10.0;

        for (INotification var6 : field2142.keySet()) {
            long var7 = System.currentTimeMillis() - field2142.get(var6);
