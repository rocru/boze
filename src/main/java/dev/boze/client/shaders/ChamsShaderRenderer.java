...
public class ChamsShaderRenderer implements IMinecraft {
    ...
    public static void method1307(float tickDelta, MatrixStack matrices, Camera camera) {
        if (Chams.INSTANCE.isEnabled()) {
            if (Chams.INSTANCE.field3463.getValue() == ChamsMode.Normal || Chams.INSTANCE.field3463.getValue() == ChamsMode.Both) {
                ...
                ShaderRegistry.field2265.method581("u_Size", mc.getWindow().getFramebufferWidth(), mc.getWindow().getFramebufferHeight());
                ShaderRegistry.field2265.method690("u_Src_Texture", 0);
                ShaderRegistry.field2265.method691("u_Opacity", Chams.INSTANCE.field3464.getValue().floatValue());
            ...
            var9.method2142();
            var9.method581("u_Size", mc.getWindow().getFramebufferWidth(), mc.getWindow().getFramebufferHeight());
            ...
            var9.method693(
                    "u_Fill",
                    (float) Chams.INSTANCE.field3473.getValue().field408 / 255.0F,
                    (float) Chams.INSTANCE.field3473.getValue().field409 / 255.0F,
                    (float) Chams.INSTANCE.field3473.getValue().field410 / 255.0F,
                    (float) Chams.INSTANCE.field3473.getValue().field411 / 255.0F
            );
            ...
            var9.method693(
                    "u_Hidden",
                    (float) Chams.INSTANCE.field3474.getValue().field408 / 255.0F,
                    (float) Chams.INSTANCE.field3474.getValue().field409 / 255.0F,
                    (float) Chams.INSTANCE.field3474.getValue().field410 / 255.0F,
                    0.0
            );
            ...
            var9.method693(
                    "u_Outline",
                    (float) Chams.INSTANCE.field3475.getValue().field408 / 255.0F,
                    (float) Chams.INSTANCE.field3475.getValue().field409 / 255.0F,
                    (float) Chams.INSTANCE.field3475.getValue().field410 / 255.0F,
                    (float) Chams.INSTANCE.field3475.getValue().field411 / 255.0F
            );
            ...
            var9.method691("u_Opacity", (float) Chams.INSTANCE.field3471.getValue().intValue() / 255.0F);
            var9.method691("u_Glow", Chams.INSTANCE.field3469.getValue().floatValue());
            var9.method691("u_Glow_Strength", Chams.INSTANCE.field3470.getValue().floatValue());
    ...
    public static void method1311(
        ...
        var14.method2142();
        var14.method581("u_Size", mc.getWindow().getFramebufferWidth(), mc.getWindow().getFramebufferHeight());
        ...
        var14.method693(
                "u_Fill",
                (float) fill.field408 / 255.0F,
                (float) fill.field409 / 255.0F,
                (float) fill.field410 / 255.0F,
                (float) fill.field411 / 255.0F
        );
        ...
        var14.method693(
                "u_Outline",
                (float) outline.field408 / 255.0F,
                (float) outline.field409 / 255.0F,
                (float) outline.field410 / 255.0F,
                (float) outline.field411 / 255.0F
        );
        ...
        var14.method691("u_Opacity", opacity);
        var14.method691("u_Glow", glow);
        var14.method691("u_Glow_Strength", glowStrength);
    ...
    public static void method1312(Runnable draw, boolean fastRender, BozeDrawColor outline, int radius, float glow, float glowStrength) {
        ...
        var9.method691("u_Glow", glow);
        var9.method691("u_Glow_Strength", glowStrength);
        GL.method1211(field2244.getColorAttachment());
        QuadRenderer.method1215();
        var9.method1416();
    }
