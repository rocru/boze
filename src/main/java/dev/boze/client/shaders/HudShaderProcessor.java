...
public class HudShaderProcessor extends ShaderProcessor implements IMinecraft {
   ...
   public void applyShader(Runnable draw, Framebuffer framebuffer, Framebuffer blurFramebuffer) {
      if (this.field1368 != null) {
         ...
         this.field1368.method581("u_Size", (double)mc.getWindow().getFramebufferWidth(), (double)mc.getWindow().getFramebufferHeight());
         this.field1368.method690("u_Src_Texture", 0);
         this.field1368.method690("u_Dst_Texture", 2);
         this.field1368
            .method693(
               "u_Fill",
               (double)((float)this.field1367.method457().method1362().field408 / 255.0F),
               (double)((float)this.field1367.method457().method1362().field409 / 255.0F),
               (double)((float)this.field1367.method457().method1362().field410 / 255.0F),
               (double)((float)this.field1367.method457().method1362().field411 / 255.0F)
            );
         ...
         this.field1368
            .method693(
               "u_Outline",
               (double)((float)this.field1367.method458().method1362().field408 / 255.0F),
               (double)((float)this.field1367.method458().method1362().field409 / 255.0F),
               (double)((float)this.field1367.method458().method1362().field410 / 255.0F),
               (double)((float)this.field1367.method458().method1362().field411 / 255.0F)
            );
         ...
         this.field1368.method691("u_GlowSize", (double)this.field1367.method458().method1384());
         this.field1368.method691("u_MaxGlow", (double)this.field1367.method458().method1385());
