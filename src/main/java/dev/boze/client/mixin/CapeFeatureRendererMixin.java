...
public class CapeFeatureRendererMixin {
   ...
   private Identifier onGetCapeTexture(
      ...
      if (Capes.INSTANCE.isEnabled()) {
         ...
         String var15 = (String)Capes.field1290.getOrDefault(var14.getId().toString(), "none");
         ...
         if (!Capes.field1296.isEmpty()) {
            Identifier var16 = (Identifier)Capes.field1296.getOrDefault(var14.getId().toString(), null);
            if (var16 != null) {
               return var16;
            }
         }
