   ...
   private Identifier modifyCapeTexture(
      ...
      if (var5 instanceof AbstractClientPlayerEntity var14) {
         if (Capes.INSTANCE.isEnabled()) {
            ...
            String var16 = (String)Capes.field1290.getOrDefault(var15.getId().toString(), "none");
            ...
            if (!Capes.field1296.isEmpty()) {
               Identifier var17 = (Identifier)Capes.field1296.getOrDefault(var15.getId().toString(), null);
               if (var17 != null) {
                  return var17;
               }
            }
