...
public class BossBarHudMixin {
    ...
    public Iterator<ClientBossBar> onIterate(Collection<ClientBossBar> collection) {
        BossBarIteratorEvent var2 = Boze.EVENT_BUS.post(BossBarIteratorEvent.method1052(collection.iterator()));
    ...
    public Text onGetName(ClientBossBar clientBossBar) {
        BossBarNameEvent var2 = Boze.EVENT_BUS.post(BossBarNameEvent.method1053(clientBossBar, clientBossBar.getName()));
        return var2.text;
    }
