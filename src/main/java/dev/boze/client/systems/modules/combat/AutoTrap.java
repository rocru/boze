...
public class AutoTrap extends Module {
    ...
    private Boolean lambda$onGhostRotate$2(RotationHelper var1) {
        ...
        if (var5.getType() == Type.MISS) {
            ...
            return var5.getBlockPos() == this.field2541.getBlockPos() && var5.getSide() == this.field2541.getSide();
        }
    }

    private boolean lambda$calculate$1(LivingEntity var1, BlockPos var2) {
        return !this.noFeetReplace.getValue() || var2.getY() != (int) Math.floor(var1.getY()) || !this.field2546.contains(var2);
    }
