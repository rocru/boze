...
public class FreeCam extends Module {
    ...
    public void onEnable() {
        if (!MinecraftUtils.isClientActive()) {
            ...
            this.field3551 = mc.options.getBobView().getValue();
    ...
    public double method1947(float tickDelta) {
        return MathHelper.lerp(tickDelta, this.field3545, this.field3540);
    }

    public double method1948(float tickDelta) {
        return MathHelper.lerp(tickDelta, this.field3546, this.field3541);
    }

    public double method1949(float tickDelta) {
        return MathHelper.lerp(tickDelta, this.field3547, this.field3542);
    }
    ...
    public final Vec3d method1952(float tickDelta) {
        double var2 = MathHelper.lerp(tickDelta, this.field3545, this.field3540);
        double var4 = MathHelper.lerp(tickDelta, this.field3546, this.field3541);
        double var6 = MathHelper.lerp(tickDelta, this.field3547, this.field3542);
