...
public class TunnelESP extends Module {
   ...
   private final BooleanSetting field3818 = new BooleanSetting("Shader", false, "Use a shader");
   ...
   private static byte method2068(int var0) {
      return (byte)(var0 >> 24 & 0xFF);
   }

   private static short method2069(int var0) {
      return (short)(var0 >> 8 & 65535);
   }

   private static byte method2070(int var0) {
         ...
         if (var7 == 1) {
            ...
            if (var8 == 1) {
               ...
               if (var9 == 1) {
                  ...
                  return var10 == 1 ? false : var7 == 0 && var8 == 0 && var9 == 2 && var10 == 2 || var7 == 2 && var8 == 2 && var9 == 0 && var10 == 0;
               }
            }
         }
      }
   ...
   private boolean method2076(int var1, int var2, int var3) {
      ...
      if (var7.isAir()) {
         ...
         return !var7.getFluidState().isEmpty() ? false : !var7.getCollisionShape(mc.world, this.field3830.set(var1, var2, var3)).isEmpty();
      }
   }
   ...
   private boolean method2078(int var1, int var2, int var3) {
      if (!this.method2076(var1, var2 - 1, var3)) {
         ...
         return this.method2077(var1, var2 + 2, var3) ? false : this.method2077(var1, var2 + 1, var3);
      }
   }

   private boolean method2079(TunnelRenderer var1, int var2, int var3, int var4) {
      int var8;
      if (var2 == -1) {
         var1 = (TunnelRenderer)this.field3831.get(ChunkPos.toLong(var1.field3833 - 1, var1.field3834));
         var8 = method2067(15, var3, var4);
      } else if (var2 == 16) {
         var1 = (TunnelRenderer)this.field3831.get(ChunkPos.toLong(var1.field3833 + 1, var1.field3834));
         var8 = method2067(0, var3, var4);
      } else if (var4 == -1) {
         var1 = (TunnelRenderer)this.field3831.get(ChunkPos.toLong(var1.field3833, var1.field3834 - 1));
