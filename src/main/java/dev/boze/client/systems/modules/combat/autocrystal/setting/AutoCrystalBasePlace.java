...
public class AutoCrystalBasePlace implements IMinecraft, Class5912, SettingsGroup {
    ...
    private List<BlockPos> method1144() {
        ...
        int var6 = (int) Math.ceil(this.field126.autoCrystalPlace.field138.getValue() + 1.0F);
        int var7 = (int) Math.ceil(this.field126.autoCrystalPlace.field138.getValue() + 1.0F);
