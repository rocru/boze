...
public class ArrayList extends HUDModule {
    ...
    public void method2041(MovementEvent event) {
        if (this.isEnabled() && this.field651.getValue() && this.field650.getValue()) {
            for (ToggleableModule var6 : BozeInstance.INSTANCE.getModules()) {
                if (this.field660.getOrDefault(var6, var6.getState()) != var6.getState()) {
    ...
    public void method295(DrawContext context) {
        Iterator<Entry<ArrayListModuleInfo, Long>> var5 = this.field659.entrySet().iterator();

        while (var5.hasNext()) {
            Entry<ArrayListModuleInfo, Long> var6 = var5.next();
            long var7 = var6.getValue();
        ...
        List<ArrayListModuleInfo> var10 = this.method2120().stream().filter(this::lambda$onRender$0).toList();
        this.field661 = (float) var10.stream().mapToDouble(this::lambda$onRender$1).max().orElse(0.0);
        this.method314(this.field661);
        var10.stream().sorted(Comparator.comparingDouble(arg_0 -> this.lambda$onRender$2(var8, arg_0))).forEach(arg_0 -> this.lambda$onRender$3(var15, var13, var14, arg_0));
        this.method316(var13[0]);
    }

    private java.util.ArrayList<ArrayListModuleInfo> method2120() {
        java.util.ArrayList var4 = Boze.getModules()
                .modules
                .stream()
    ...
    private void lambda$onRender$3(boolean var1, int[] var2, int[] var3, ArrayListModuleInfo var4) {
        ...
        if (this.field651.getValue() && this.field659.containsKey(var4)) {
            long var13 = this.field659.get(var4);
