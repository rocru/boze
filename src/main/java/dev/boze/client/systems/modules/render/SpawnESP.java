...
public class SpawnESP extends Module {
   ...
   private final ColorSetting field768 = new ColorSetting("Current", new BozeDrawColor(-65536), "Color for blocks where mobs can currently spawn");
   private final ColorSetting field769 = new ColorSetting("Later", new BozeDrawColor(-256), "Color for blocks where mobs might spawn later (i.e. at night)");
   ...
   private static boolean method360(BlockState var0) {
      return var0.getBlock() instanceof SlabBlock && var0.get(SlabBlock.TYPE) == SlabType.TOP
         ? true
         : var0.getBlock() instanceof StairsBlock && var0.get(StairsBlock.HALF) == BlockHalf.TOP;
   }
