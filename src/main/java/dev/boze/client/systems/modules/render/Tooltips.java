...
public class Tooltips extends Module {
    ...
    private void method2043(TooltipDataEvent var1) {
        if (!this.field3758.getValue().isValid() || this.field3758.getValue().isPressed()) {
            if (var1.field1959.getItem() == Items.FILLED_MAP && this.field3759.getValue()) {
                MapIdComponent var8 = var1.field1959.get(DataComponentTypes.MAP_ID);
                if (var8 != null) {
                ...
                BannerPatternsComponent var7 = var1.field1959.get(DataComponentTypes.BANNER_PATTERNS);
                if (var7 != null) {
    ...
    private ItemStack method2044(List<Layer> var1) {
        ...
        BannerPatternsComponent var3 = var2.get(DataComponentTypes.BANNER_PATTERNS);
    ...
    private ItemStack method2045(ItemStack var1) {
        if (var1.getComponents().isEmpty() && var1.get(DataComponentTypes.BLOCK_ENTITY_DATA) != null && var1.get(DataComponentTypes.BASE_COLOR) != null) {
            ...
            BannerPatternsComponent var6 = var5.get(DataComponentTypes.BANNER_PATTERNS);
            BannerPatternsComponent var7 = var1.get(DataComponentTypes.BANNER_PATTERNS);
            if (var7 == null) {
                return var5;
            } else {
