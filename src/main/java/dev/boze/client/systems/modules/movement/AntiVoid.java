...
public class AntiVoid extends Module {
    ...
    public void method1693(HandleInputEvent event) {
        if (this.method280() == AntiVoidMode.Ghost
                ...
                && !this.field562
                && mc.world.isSpaceEmpty(mc.player.getBoundingBox().withMinY(mc.world.getBottomY()))
    ...
    public void method1695(MouseUpdateEvent event) {
        if (MinecraftUtils.isClientActive()
                ...
                && !mc.player.isCreative()) {
            if (mc.player.fallDistance >= this.field551.getValue() && mc.world.isSpaceEmpty(mc.player.getBoundingBox().withMinY(mc.world.getBottomY()))) {
                ItemStack var5 = mc.player.getMainHandStack();
                if (var5.isEmpty() || var5.getItem() != Items.ENDER_PEARL) {
                    var5 = mc.player.getOffHandStack();
                }
    ...
    private Vec3d method1954() {
        if (this.field561 == null) {
            ...
            Vec3d var8 = new Vec3d((double) this.field561.getX() + 0.5, this.field561.getY() + 1, (double) this.field561.getZ() + 0.5);
            float var9 = (float) (-Math.toDegrees(this.method281(var8, 1.5, 0.03)));
            if (Float.isNaN(var9)) {
                return null;
            } else {
