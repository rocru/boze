...
public class SelfFill extends Module {
   ...
   private EnumSetting<SelfFillMode> selfFillMode = new EnumSetting<SelfFillMode>("Type", SelfFillMode.Burrow, "Type of SelfFill");
   private final EnumSetting<PlaceMode> placeMode = new EnumSetting<PlaceMode>("Place", PlaceMode.Vanilla, "Place mode");
   private EnumSetting<AnticheatMode> interactionMode = new EnumSetting<AnticheatMode>("Mode", AnticheatMode.NCP, "Mode to use for placing", this::lambda$new$0);
   private BooleanSetting rotate = new BooleanSetting("Rotate", true, "Rotate");
   private BooleanSetting swing = new BooleanSetting("Swing", true, "Swing", this::lambda$new$1);
   private BooleanSetting onlyEChests = new BooleanSetting("OnlyEChests", false, "Only use E-Chests", this::lambda$new$2);
