...
public class Blur extends Module {
    ...
    public void method1904() {
        ...
        if (this.field3416) {
            ...
            ShaderRegistry.field2267.method581("u_Size", mc.getWindow().getFramebufferWidth(), mc.getWindow().getFramebufferHeight());
            ShaderRegistry.field2267.method690("u_Src_Texture", 0);
            ShaderRegistry.field2267
                    .method693(
                            "u_Color",
                            (float) this.field3411.getValue().field408 / 255.0F,
                            (float) this.field3411.getValue().field409 / 255.0F,
                            (float) this.field3411.getValue().field410 / 255.0F,
                            (float) this.field3411.getValue().field411 / 255.0F
                    );
