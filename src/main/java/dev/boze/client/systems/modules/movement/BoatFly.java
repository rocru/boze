...
public class BoatFly extends Module {
    ...
    public final MinMaxSetting field3163 = new MinMaxSetting("HorizSpeed", 1.0, 0.01, 1.0, 0.01, "Horizontal speed factor", this::lambda$new$10);
    public final MinMaxSetting field3164 = new MinMaxSetting("VerticalSpeed", 1.0, 0.01, 1.0, 0.01, "Vertical speed factor", this::lambda$new$11);
    public final BindSetting field3165 = new BindSetting("SlowDown", Bind.fromKey(342), "Key to slow down", this::lambda$new$12);
    public final MinMaxSetting field3166 = new MinMaxSetting("Factor", 0.95, 0.01, 1.0, 0.01, "Slow down factor", this::lambda$new$13, this.field3165);
    public final IntSetting field3167 = new IntSetting(
            "SyncInterval", 10, 1, 100, 1, "Sync interval\nIf you get kicked, try lowering this\nIt's ping-dependent\n", this::lambda$new$14
    );
    public final BooleanSetting field3168 = new BooleanSetting("RayCast", true, "RayCast to prevent teleporting into blocks or nether roof", this::lambda$new$15);
    public final BooleanSetting field3169 = new BooleanSetting(
            "AutoPilot", false, "Automatically path-finds and avoids obstacles\nExperimental feature\nUse at y=121 for best results\n", this::lambda$new$16
    );
    public final BooleanSetting field3170 = new BooleanSetting("LockOn", false, "Lock onto initial direction when enabled", this.field3169);
    public final IntSetting field3171 = new IntSetting(
    ...
    public final IntSetting field3173 = new IntSetting("TicksAhead", 10, 5, 15, 1, "How many fly ticks ahead to pathfind", this.field3169);
    public final IntSetting field3174 = new IntSetting("MaxFails", 10, 1, 20, 1, "Max pathfinding fails before autopilot is disabled", this.field3169);
    public final MinMaxSetting field3175 = new MinMaxSetting(
            "RetryDelay",
            5.0,
            0.1,
            20.0,
    ...
    public final BooleanSetting field3177 = new BooleanSetting(
            "Cache",
            false,
    ...
    public final BooleanSetting field3178 = new BooleanSetting("Render", true, "Render the path", this.field3169);
    public final ColorSetting field3179 = new ColorSetting("Color", new BozeDrawColor(-7046189), "Color for path", this.field3178::getValue, this.field3169);
    ...
    public boolean method1792() {
        return this.isEnabled() && this.field3151.getValue().method903(this).method2115();
    }
    ...
    public boolean method1797() {
        return this.isEnabled() && this.field3151.getValue().method903(this).method2114();
    }

    public boolean method1798(VehicleMoveS2CPacket packet) {
        return this.isEnabled() && this.field3151.getValue().method903(this).method1798(packet);
    }
