...
public class StorageESP extends Module {
    ...
    private final BooleanSetting field3714 = new BooleanSetting("Chests", true, "Apply ESP to Chests");
    private final RGBASetting field3715 = new RGBASetting("Color", new RGBAColor(1090511181), "Color for chest boxes", this::lambda$new$5, this.field3714);
    private final RGBASetting field3716 = new RGBASetting("Outline", new RGBAColor(-7859), "Color for chest box outline", this.field3714);
    private final BooleanSetting field3717 = new BooleanSetting("TrappedChests", true, "Apply ESP to Trapped Chests");
    private final RGBASetting field3718 = new RGBASetting("Color", new RGBAColor(1090503757), "Color for trapped chest boxes", this::lambda$new$6, this.field3717);
    private final RGBASetting field3719 = new RGBASetting("Outline", new RGBAColor(-15283), "Color for trapped chest box outline", this.field3717);
    private final BooleanSetting field3720 = new BooleanSetting("Barrels", true, "Apply ESP to Barrels");
    private final RGBASetting field3721 = new RGBASetting("Color", new RGBAColor(1090507341), "Color for barrels", this::lambda$new$7, this.field3720);
    private final RGBASetting field3722 = new RGBASetting("Outline", new RGBAColor(-11699), "Color for barrel outline", this.field3720);
    private final BooleanSetting field3723 = new BooleanSetting("EnderChests", true, "Apply ESP to Ender Chests");
    private final RGBASetting field3724 = new RGBASetting("Color", new RGBAColor(1078853512), "Color for ender chest boxes", this::lambda$new$8, this.field3723);
    private final RGBASetting field3725 = new RGBASetting("Outline", new RGBAColor(-11665528), "Color for ender chest box outline", this.field3723);
    private final BooleanSetting field3726 = new BooleanSetting("Shulkers", true, "Apply ESP to Shulkers");
    private final BooleanSetting field3727 = new BooleanSetting("Dynamic", true, "Use vanilla shulker colors", this.field3726);
    private final RGBASetting aa = new RGBASetting("Color", new RGBAColor(1088507391), "Color for shulker boxes", this::lambda$new$9, this.field3726);
    private final RGBASetting ab = new RGBASetting("Outline", new RGBAColor(-2011649), "Color for shulker outline", this::lambda$new$10, this.field3726);
    ...
    private List<WorldChunk> method2033() {
        ArrayList var4 = new ArrayList();
        int var5 = mc.options.getViewDistance().getValue();
    ...
    private double method2034(BlockEntity var1) {
        if (!this.field3711.getValue()) {
            ...
            if (var5 <= (double) this.field3712.getValue().floatValue()) {
                ...
                var5 -= this.field3712.getValue().floatValue();
    ...
    private boolean method2035(BlockEntity var1) {
        if (var1 instanceof TrappedChestBlockEntity) {
            ...
            return (var1 instanceof AbstractFurnaceBlockEntity || var1 instanceof DispenserBlockEntity || var1 instanceof HopperBlockEntity) && this.ac.getValue();
        }
    }
    ...
    private void method2038(Renderer3D var1, BlockEntity var2, RGBAColor var3, RGBAColor var4) {
        double var8 = var2.getPos().getX();
        double var10 = var2.getPos().getY();
        double var12 = var2.getPos().getZ();
        double var14 = var2.getPos().getX() + 1;
        double var16 = var2.getPos().getY() + 1;
        double var18 = var2.getPos().getZ() + 1;
        byte var20 = 0;
