...
public class Replenish extends Module {
               ...
               if (var5 == null || var5.getCursorStack().isEmpty()) {
                  ...
                  if (this.field3078.hasElapsed(this.field3079 && !this.field3061.method419() ? this.field3064.getValue() * 50.0 : (double)this.field3081)) {
                     ...
                     if (var6 != null) {
                        ...
                        this.field3080 = var7;
                        float var9 = (float)Math.sqrt((double)var8) / new Vec2f(176.0F, 166.0F).length();
   ...
   private void method1755(int var1, ItemStack var2) {
      if (var1 != -1 && !dev.boze.client.utils.InventoryUtil.method159(var1)) {
         if (System.currentTimeMillis() - (Long)this.field3077.getOrDefault(var1, 0L) >= 1000L) {
   ...
   private void method1761(int var1, ItemStack var2) {
      if (this.method1751() != ReplenishMode.Ghost || !var2.isEmpty() || this.field3082) {
         ...
         ((ItemStackAccessor)var6).setItem(var2.getItem());
         var6.setCount(var2.getCount());
         var6.applyComponentsFrom(var2.getComponents());
         if (var2.isEmpty()) {
            ((ItemStackAccessor)var6).setItem(Items.AIR);
         }
      }
   }
