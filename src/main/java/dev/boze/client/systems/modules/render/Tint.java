...
public class Tint extends Module {
    ...
    private void method2040(Render2DEvent var1) {
        if (this.ag.getValue()) {
            ...
            RenderUtil.field3963.method2252(0.0, 0.0, mc.getWindow().getScaledWidth(), mc.getWindow().getScaledHeight(), this.ah.getValue());
    ...
    private void method2041(MovementEvent var1) {
        if (this.field3728.getValue()) {
            mc.world.setTimeOfDay(this.field3729.getValue().intValue());
        }
    }
