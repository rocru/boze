...
public class AutoTool extends Module {
    ...
    public void method1680(HandleInputEvent event) {
        if (!this.method1679() && this.field2909.hasElapsed(this.field2900.method1367() * 50)) {
            if (mc.interactionManager.isBreakingBlock()) {
                ...
                int var6 = InventoryHelper.method174(arg_0 -> AutoTool.lambda$handleHotbar$1(var5, arg_0), SwapMode.Normal);
    ...
    @EventHandler
    private void method1681(PreBlockBreakEvent preBlockBreakEvent) {
        if (this.method1678()) {
            return;
        }
        int n = InventoryHelper.method174(arg_0 -> AutoTool.lambda$onMinePre$2(preBlockBreakEvent, arg_0), this.field2901.getValue());
        if (n != -1) {
            this.field2910.reset();
        }
        if (n != AutoTool.mc.player.getInventory().selectedSlot && n != -1 && n != this.field2907) {
            InventoryUtil.method534(this, 7, this.field2901.getValue(), n);
