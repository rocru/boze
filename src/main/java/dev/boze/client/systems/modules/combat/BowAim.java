      ...
      if (!var4 && !var5) {
         ...
         if (var6 == null) {
            ...
            if (var4) {
               ...
               var7 = CrossbowItemAccessor.getSpeed((ChargedProjectilesComponent)mc.player.getMainHandStack().get(DataComponentTypes.CHARGED_PROJECTILES));
            }
            ...
            if (Float.isNaN(var25)) {
               ...
               double var19 = (double)mc.player.distanceTo(var6);
               var19 -= var19 % 2.0;
