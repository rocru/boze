...
public class AutoWalk extends Module {
   ...
   public void method1788(PrePlayerTickEvent event) {
      if (this.field3148.method461() == AutoWalkMode.Key) {
   ...
   public void method1789(TickInputPostEvent event) {
      if (this.field3148.method461() == AutoWalkMode.Input) {
         if (BaritoneAPI.getProvider().getPrimaryBaritone().getPathingBehavior().getGoal() != null) {
            BaritoneAPI.getProvider().getPrimaryBaritone().getPathingBehavior().cancelEverything();
         }

         event.field1954 = this.field3147.method419() ? -1.0F : 1.0F;
      }
   }

   @EventHandler
   public void method1790(PostPlayerTickEvent event) {
      if (this.field3148.method461() == AutoWalkMode.Baritone && BaritoneAPI.getProvider().getPrimaryBaritone().getPathingBehavior().getGoal() == null) {
         if (this.field3150 == null) {
            this.field3150 = mc.player.getYaw();
         }

         float var5 = (float)Math.toRadians((double)MathHelper.wrapDegrees(this.field3150 - (float)(this.field3147.method419() ? 180 : 0)));
