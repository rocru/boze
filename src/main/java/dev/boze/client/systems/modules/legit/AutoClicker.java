...
public class AutoClicker extends Module {
   ...
   private void method1587(KeyBinding var1, ClickManager var2, RotationEvent var3, boolean var4) {
      if (!var1.isPressed()) {
         ((Timer)this.field2750.get(var1)).reset();
      }

      if ((!var1.isPressed() || !((Timer)this.field2750.get(var1)).hasElapsed(1000.0 * ((MinMaxDoubleSetting)this.field2751.get(var1)).method1295())) && var4) {
         var2.method2172();
      } else {
         ...
         if (var8 > 0 && ((KeyBindingAccessor)var1).getTimesPressed() == 0) {
            ...
            ((MinMaxDoubleSetting)this.field2751.get(var1)).method1296();
         }
      }
   }
