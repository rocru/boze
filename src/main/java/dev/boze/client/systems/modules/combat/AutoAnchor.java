            ...
            if (!mc.world.getRegistryKey().getValue().getPath().equals("the_nether")) {
                if (!Options.method477(this.multitask.getValue())) {
                    if (!(mc.player.getHealth() + mc.player.getAbsorptionAmount() < this.minHealth.getValue())) {
                        if (this.field2501.hasElapsed(1000.0F - this.speed.getValue() * 50.0F)) {
                            this.field2504 = null;
                            ...
                            if (var5 != -1 && var6 != -1) {
                                ...
                                if (!var7.isEmpty()) {
                                    ...
                                    if (this.field2508 == null && this.field2506 == null && this.mineObstruction.getValue()) {
                                        ...
                                        Vec3d var9 = qG.method735(var8, this.range.getValue().floatValue(), true);
                                        if (var9 != null) {
                                            this.field2502 = var9;
    ...
    private boolean method1435(Entity var1) {
        if (var1 instanceof PlayerEntity) {
            if (var1 == mc.player) {
                ...
                return !(var1 instanceof FakePlayerEntity) && !Friends.method2055(var1);
            }
        } else {
            return false;
        }
