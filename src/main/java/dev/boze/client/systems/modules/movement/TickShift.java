...
public class TickShift extends Module {
    ...
    public String method1322() {
        if (this.field895) {
            ...
            return this.field897.hasElapsed(this.field886.getValue() * 1000.0F) ? "Ready" : "Charging";
        }
    }
    ...
    public void onDisable() {
        try {
            ...
            while (!this.field901.isEmpty()) {
                mc.player.networkHandler.sendPacket(this.field901.poll());
            }
    ...
    public void method2041(MovementEvent event) {
        ...
        if (this.method1971() && mc.player.age > 50) {
            ...
            } else if (this.field897.hasElapsed(this.field886.getValue() * 1000.0F)
            ...
            if (event.packet instanceof PlayerMoveC2SPacket) {
                ...
                if (this.field887.getValue() && !this.method1971()) {
                    ...
                    if (this.field890.getValue() > 0 && this.field900 > 10 - this.field890.getValue()
                            || !this.field899.hasElapsed(this.field888.getValue() * 1000)) {
                        this.field900 = 0;
                        event.method1020();
                    }
    ...
    private boolean method1971() {
        if (mc.player.getX() != mc.player.prevX) {
            ...
            return mc.player.getY() != mc.player.prevY || mc.player.getZ() != mc.player.prevZ;
        }
    }
}
