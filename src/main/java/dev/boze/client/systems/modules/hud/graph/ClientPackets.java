...
public class ClientPackets extends GraphHUDModule {
   ...
   public void method1564(PrePacketSendEvent event) {
      if (this.field2668.method461() == CountMode.Tick) {
         this.field2669++;
      }
   }
   ...
   public void method1565(PostTickEvent event) {
      if (MinecraftUtils.isClientActive()) {
         if (this.field2668.method461() == CountMode.Second) {
            if (mc.player.age % 20 == 0) {
               if (mc.getNetworkHandler() == null || mc.getNetworkHandler().getConnection() == null) {
                  return;
               }

               this.method1324((double)mc.getNetworkHandler().getConnection().getAveragePacketsSent());
            }
         } else {
            this.method1324((double)this.field2669);
            this.field2669 = 0;
         }
      }
   }
