...
public class AutoScoreboard extends Module {
            ...
            if (var6 instanceof LivingEntity var7) {
                if (var7.getHealth() <= 0.0F) {
                    if (this.field2897.containsKey(var7.getName().getString())) {
                        Pair var8 = this.field2897.get(var7.getName().getString());
                        this.field2897.put(var7.getName().getString(), new Pair((Integer) var8.getLeft() + 1, var8.getRight()));
                    ...
                    if (this.taunt.getValue()) {
                        Pair var9 = this.field2897.get(var7.getName().getString());
            ...
            for (Entity var6 : TargetTracker.method560()) {
                if (var6 instanceof LivingEntity var7) {
                    if (var7.getHealth() > 0.0F) {
                        if (this.field2897.containsKey(var7.getName().getString())) {
                            Pair var8 = this.field2897.get(var7.getName().getString());
                            this.field2897.put(var7.getName().getString(), new Pair(var8.getLeft(), (Integer) var8.getRight() + 1));
                            ChatInstance.method624(this.method1676(var7.getName().getString(), (Integer) var8.getLeft(), (Integer) var8.getRight()));
                        } else {
    ...
    public JsonObject serialize() {
        ...
        this.field2897.forEach((arg_0, arg_1) -> AutoScoreboard.lambda$saveLocalData$0(jsonObject2, arg_0, arg_1));
