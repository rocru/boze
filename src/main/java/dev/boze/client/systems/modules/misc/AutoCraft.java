...
public class AutoCraft extends Module {
    ...
    private final Queue<Runnable> field2884 = new LinkedList();
        ...
        if (!(mc.player.currentScreenHandler instanceof CraftingScreenHandler)) {
            ...
            if (this.field2885 > 0) {
                ...
                if (var5 == Items.FIREWORK_ROCKET && this.fireworks.getValue()) {
                    ...
                    if (var12 != -1 && var13 != -1) {
                        this.field2884.add(() -> lambda$onSendMovementPackets$3(var12));
                        this.field2884.add(() -> lambda$onSendMovementPackets$4(var13));
