        ...
        for (Entity var6 : mc.world.getEntities()) {
            if (this.field3665.method2055(var6)) {
                ...
                if (!(var7 > this.field3663.getValue())) {
                    double var9 = MathHelper.lerp(event.field1951, var6.lastRenderX, var6.getX());
                    double var11 = MathHelper.lerp(event.field1951, var6.lastRenderY, var6.getY());
                    double var13 = MathHelper.lerp(event.field1951, var6.lastRenderZ, var6.getZ());
