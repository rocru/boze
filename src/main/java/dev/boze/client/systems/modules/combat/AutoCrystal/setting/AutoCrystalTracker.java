...
public class AutoCrystalTracker implements IMinecraft {
   ...
   private HashMap<BlockPos, Long> field1539 = new HashMap();
   private final int[] field1540 = new int[10];
   private int field1541 = 0;
   private HashMap<BlockPos, Long> field1542 = new HashMap();
   private HashMap<BlockPos, Integer> field1543 = new HashMap();
   ...
   void update() {
      ...
      if (this.field1532.hasElapsed((double)(this.method215() * 3.0F))) {
         this.field1533 = null;
      }
   }
   ...
   void remove(BlockPos var1) {
      try {
         long var5 = (Long)this.field1542.remove(var1);
   ...
   void method682(BlockPos var1) {
      try {
         long var5 = (Long)this.field1539.remove(var1);
         int var7 = (int)(System.currentTimeMillis() - var5);
         if (var7 > 350) {
            return;
         }
