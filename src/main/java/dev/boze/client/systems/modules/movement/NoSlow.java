...
public class NoSlow extends Module {
    ...
    private final BooleanSetting field3313 = new BooleanSetting(
            "OnlyPickup", false, "Only apply strict to pickups, not swaps or quickmoves", this::lambda$new$2, this.field3312
    );
    private final BooleanSetting field3314 = new BooleanSetting("Sneak", false, "Allows you to sneak while in inventories", this.field3312);
    private final BooleanSetting field3315 = new BooleanSetting("Look", true, "Lets you use arrow keys to look around while in inventories", this.field3312);
    ...
    public void method1850(MovementEvent event) {
        ...
        if (!this.field3320.isEmpty() && !mc.player.isUsingItem() && !this.field3321) {
            while (!this.field3320.isEmpty()) {
                mc.player.networkHandler.sendPacket(this.field3320.poll());
            }
    ...
    private boolean method1858(Screen var1) {
        return var1 != null && !(var1 instanceof ChatScreen)
