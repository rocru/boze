...
public class nk extends nj {
    ...
    private boolean method2116() {
        return this.field1572 != null && this.field1573 != null && nm.method1799(this.field1566, this.field1572, 1.5) && this.field1572.y - this.field1573.y > -0.03125;
    }
        ...
        if (this.field1556.field3169.getValue()
            ...
            if (this.field1556.field3177.getValue()
                ...
                for (int var6 = this.field1576.field3878; var6 < this.field1576.field3877.size(); var6++) {
                    Vec3d var7 = this.field1576.field3877.get(var6);
            ...
            if (this.field1556.field3170.getValue() && this.field1579 != null && this.field1580 != null) {
                var15.method2121(this.field1579, this.field1580, BoatFly.INSTANCE.field3171.getValue().intValue());
            }
    ...
    private Vec3d method1952(float var1) {
        ...
        if (var11) {
            ...
            float var24 = -((float) Math.toRadians(MathHelper.wrapDegrees(var23)));
