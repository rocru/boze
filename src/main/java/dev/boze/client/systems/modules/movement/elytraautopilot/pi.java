...
public class pi implements IMinecraft {
   ...
   public static void method1416() {
      if (!field1109) {
         if (mc.player != null) {
            ...
            Item var17 = ((ItemStack)mc.player.getInventory().armor.get(2)).getItem();
            int var6 = ((ItemStack)mc.player.getInventory().armor.get(2)).getMaxDamage() - ((ItemStack)mc.player.getInventory().armor.get(2)).getDamage();
   ...
   private static boolean method2115() {
      int var3 = ((ItemStack)mc.player.getInventory().armor.get(2)).getMaxDamage() - ((ItemStack)mc.player.getInventory().armor.get(2)).getDamage();
      if (var3 <= 5) {
         ItemStack var4 = null;
