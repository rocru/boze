...
public class HoleESP extends Module {
        ...
        for (BlockPos var14 : this.aw) {
            this.method386(
                    ...
                    new Box(
                            ...
                            var14.getZ(),
                            var14.getX() + 1,
                            (float) var14.getY() + this.ak.getValue(),
                            var14.getZ() + 1
                    ),
                    this.al.getValue(),
                    this.am.getValue(),
    ...
    private double method387(Box var1) {
        if (!this.field874.getValue()) {
            ...
            if (var5 <= (double) this.field875.getValue().floatValue()) {
                ...
                var5 -= this.field875.getValue().floatValue();
    ...
    private double method388(BlockPos var1) {
        if (!this.field871.getValue()) {
            ...
            double var5 = new Vec3d((double) var1.getX() + 0.5, var1.getY(), (double) var1.getZ() + 0.5).distanceTo(mc.player.getEyePos());
