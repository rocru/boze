        ...
        if (!event.method554(RotationMode.Vanilla)) {
            ...
            if (this.field2835.getValue() && !mc.options.attackKey.isPressed()) {
                ...
                if (mc.interactionManager.isBreakingBlock()) {
                    ...
                    List<Entity> var13 = this.method1624();
                    if (var13.isEmpty()) {
                        this.field2853.method2172();
                        return;
                    }
                    ...
                    if (this.field2843.getValue()) {
                        ...
                        if (var7 != null) {
                            ...
                            var6 = var8.add(0.0, mc.player.getEyeHeight(mc.player.getPose()), 0.0);
                        }
                    }
    ...
    private boolean method1625(Entity var1) {
        if (var1 instanceof PlayerEntity) {
            if (var1 == mc.player) {
                ...
                return !AntiBots.method2055(var1) && this.field2846.getValue();
            }
        } else {
