...
public class AutoWeapon extends Module {
    ...
    private void method1490(PreAttackEntityEvent var1) {
        if (!Friends.method2055(var1.entity)) {
        ...
        if (this.weapon.getValue() == PreferredWeapon.Sword) {
            for (int var11 = 0; var11 < 9; var11++) {
                if (mc.player.getInventory().getStack(var11).getItem() instanceof SwordItem
                    ...
                    double var10 = ((SwordItem) mc.player.getInventory().getStack(var11).getItem()).getMaterial().getAttackDamage() + 2.0F;
                    if (var10 > var5) {
                        var5 = var10;
                        var4 = var11;
                    }
            ...
            if (this.weapon.getValue() == PreferredWeapon.Axe) {
                for (int var9 = 0; var9 < 9; var9++) {
                    if (mc.player.getInventory().getStack(var9).getItem() instanceof AxeItem
                        ...
                        double var7 = ((AxeItem) mc.player.getInventory().getStack(var9).getItem()).getMaterial().getAttackDamage() + 2.0F;
                        if (var7 > var5) {
                            var5 = var7;
                            var4 = var9;
                        }
