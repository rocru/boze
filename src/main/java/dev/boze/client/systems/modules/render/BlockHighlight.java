...
public class BlockHighlight extends Module {
    ...
    private final ConcurrentHashMap<Box, Long> field3402 = new ConcurrentHashMap();
    private final CopyOnWriteArrayList<Box> field3403 = new CopyOnWriteArrayList();
    ...
    public void method1899(Render3DEvent event) {
        if (mc.crosshairTarget != null && mc.crosshairTarget instanceof BlockHitResult var5) {
            ...
            if (var9.isEmpty()) {
                if (!(var8.getBlock() instanceof AirBlock) || !AirPlace.INSTANCE.isEnabled()) {
                    if (this.field3399.getValue() && !this.field3390.getValue()) {
                        this.field3402.forEach((v1, v2) -> lambda$onRender3D$6(event, v1, v2));
                    }
            ...
            if (this.field3399.getValue() && !this.field3390.getValue() && !this.field3400.getValue()) {
                this.field3402.forEach((v1, v2) -> lambda$onRender3D$7(event, v1, v2));
            }
            ...
            if (this.field3399.getValue() && !this.field3390.getValue()) {
                this.field3402.forEach((v1, v2) -> lambda$onRender3D$5(event, v1, v2));
            }
        }
    }
