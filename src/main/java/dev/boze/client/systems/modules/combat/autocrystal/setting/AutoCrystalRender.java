...
class AutoCrystalRender implements IMinecraft, SettingsGroup {
   ...
   AutoCrystalRender(AutoCrystal var1) {
      this.field146 = var1;
      this.field151.field2234.setVisibility(this.field150::method419);
   }
   ...
   public void method1883(RotationEvent event) {
      if (!event.method555(RotationMode.Sequential, false)) {
         if (this.field147.method419() && this.field171 != null && !this.field175.hasElapsed(1000.0)) {
            this.field174 = this.field173;
            if (this.field173 != null && this.field161.method419()) {
   ...
   public void method2071(Render3DEvent event) {
      if (AutoCrystal.field1038 && !this.field175.hasElapsed(500.0) && this.field176 != null && !mc.options.getPerspective().isFirstPerson()) {
         ...
         Vec3d var7 = var6.multiply(
            this.field146.field1041.field205.method461() == AnticheatMode.Grim ? 3.0 : (double)this.field146.autoCrystalBreak.field178.method423().floatValue()
         );
         Vec3d var8 = var6.multiply((double)this.field146.autoCrystalPlace.field138.method423().floatValue());
      ...
      if (this.field147.method419()
         && this.field173 != null
         && this.field174 != null
         && !this.field175
            .hasElapsed(
               !this.field164.method419() && !this.field165.method419() ? 1000.0 : (double)((this.field166.method423() + this.field167.method423()) * 50.0F)
            )
         && (this.field146.autoCrystalTracker.field1534 != null || this.field164.method419() || this.field165.method419())) {
         Box var11;
         if (this.field161.method419()) {
            var11 = Class3071.method6021(this.field174, this.field173, (double)event.field1951);
         } else {
            var11 = this.field171;
         }

         if (this.field164.method419()) {
            long var12 = this.field175.getElapsedTime();
            if ((float)var12 >= this.field166.method423() * 50.0F) {
               double var15 = (double)(((float)var12 - this.field166.method423() * 50.0F) / (this.field167.method423() * 50.0F));
               var11 = var11.expand(var15 * -0.5);
            }
         }

         BozeDrawColor var13 = this.field148.method1362();
         BozeDrawColor var14 = this.field149.method1362();
         if (this.field165.method419()) {
         ...
         if (this.field152.method419()) {
            ...
            ChamsShaderRenderer.method1311(
               ...
               this.field154.method419(),
               var13,
               var14,
               this.field158.method434(),
               this.field159.method423(),
               this.field156.method423(),
               this.field157.method423(),
   ...
   public void method2040(Render2DEvent event) {
      if (this.field147.method419()
         ...
         Box var5;
         if (this.field161.method419()) {
            var5 = Class3071.method6021(this.field174, this.field173, (double)event.tickDelta);
         } else {
            var5 = this.field171;
         }
   ...
   private boolean lambda$new$3() {
      return this.field164.method419() || this.field165.method419();
   }
   ...
   private boolean lambda$new$1() {
      return this.field153.method461() == AutoCrystalShaderMode.Image;
   }

   private boolean lambda$new$0() {
      return this.field156.method423() > 0.0F;
   }
}
