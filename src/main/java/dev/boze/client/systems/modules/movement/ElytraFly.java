            ...
            if (Surround.INSTANCE.autoDisable.field927) {
                if (this.field3217.getValue() == ElytraFlyMode.Packet) {
                    ...
                    if (this.field3235.getValue() && (mc.player.horizontalCollision || ElytraRecast.method286(mc.player.getPos(), mc.player.getYaw(), 15.0))) {
                        ...
                        while (true) {
                            float var23 = (float) Math.toRadians(MathHelper.wrapDegrees(mc.player.getYaw()));
                            ...
                            if (!ElytraRecast.method286(new Vec3d(var8, mc.player.getPos().y, var28), mc.player.getYaw(), 15.0) || var20 > 50.0) {
                                ...
                                var23 = (float) Math.toRadians(MathHelper.wrapDegrees(mc.player.getYaw()));
                    ...
                    if (this.field3217.getValue() == ElytraFlyMode.ControlStrict) {
                        ...
                        double var5 = Math.sin(-Math.toRadians(mc.player.getYaw())) * this.field3243;
                        double var7 = Math.cos(Math.toRadians(mc.player.getYaw())) * this.field3243;
                    ...
                    if (this.field3217.getValue() == ElytraFlyMode.ControlStrict || this.field3226.getValue()) {
                        ...
                        if (this.field3239.hasElapsed(this.field3228.getValue() * 50)) {
        ...
        if (!this.field3245) {
            if (mc.player.getEquippedStack(EquipmentSlot.CHEST).getItem() == Items.ELYTRA) {
                if (this.field3217.getValue() == ElytraFlyMode.Packet) {
                    ...
                    if (this.field3237.getValue() && this.field3240.hasElapsed(this.field3238.getValue() * 50)) {
                        if (mc.player.getMainHandStack().getItem() == Items.FIREWORK_ROCKET) {
                            mc.player.swingHand(Hand.MAIN_HAND);
                            this.field3238.resetValue();
