...
public class Render implements SettingsGroup {
        ...
        if (this.field257.getValue()) {
            ...
            while (var14.hasNext()) {
                ...
                BozeDrawColor var11 = Class3071.method6015(
                        ...
                        MathHelper.clamp((float) (System.currentTimeMillis() - var8) / (400.0F * this.field258.getValue()), 0.0, 1.0)
                );
    ...
    private void method156(Render3DEvent var1, BlockPos var2, float var3) {
        ...
        BozeDrawColor var10 = Class3071.method6015(this.field253.getValue(), this.field255.getValue(), MathHelper.clamp(var3, 0.0, 1.0));
        BozeDrawColor var11 = Class3071.method6015(this.field254.getValue(), this.field256.getValue(), MathHelper.clamp(var3, 0.0, 1.0));
