...
public class AutoFish extends Module {
    ...
    private final BooleanSetting autoCast = new BooleanSetting("AutoCast", true, "Auto cast fishing rod");
    private final BooleanSetting antiTech = new BooleanSetting(
            "AntiTechExtremist", true, "Prevents tech extremists from stealing your rare fish and mongolian fishing boots"
    );
    private final IntSetting castDelay = new IntSetting("CastDelay", 10, 0, 20, 1, "Delay for casting rod");
    ...
    private void method1667(PostPlayerTickEvent var1) {
        if (MinecraftUtils.isClientActive()) {
            if (mc.player.fishHook != null && this.timeout.getValue() > 0 && this.timer.hasElapsed(this.timeout.getValue() * 1000)) {
                this.field2890 = true;
                this.field2894 = this.catchDelay.getValue();
                this.field2895 = 0;
                this.timer.reset();
