...
public class nz {
    ...
    public void method2064(Vector3d var1) {
    ...
    private void method2065(HitResult var1) {
        if (var1.getType() == Type.BLOCK) {
            ...
            this.field3807
                    .add(Class3062.method5989(this.field3814.field3806.method5993(), var1.getPos()).add(0.0, this.field3812.getHeight() / 2.0F, 0.0));
        }
    }
            ...
            for (int var7 = 1; var7 < this.field3807.size(); var7++) {
                ...
                if (this.field3813 != -1) {
                    if (this.field3814.field3792.getValue() && this.field3808.size() > var7) {
                        if ((float) (System.currentTimeMillis() - this.field3808.get(var7 - 1)) / (this.field3814.field3791.getValue() * 1000.0F) > 1.0F) {
                        ...
                        var8 = MathHelper.clamp(
                                (float) (System.currentTimeMillis() - this.field3808.get(var7 - 1)) / (this.field3814.field3791.getValue() * 1000.0F), 0.0F, 1.0F
                        );
                        var9 = MathHelper.clamp(
                                (float) (System.currentTimeMillis() - this.field3808.get(var7)) / (this.field3814.field3791.getValue() * 1000.0F), 0.0F, 1.0F
                        );
                    }
                } else {
                ...
                if (this.field3809.length() > 0.0) {
                    double var12 = Class3071.method6022(
                            this.field3807.get(var7 - 1).x + this.field3809.x, this.field3807.get(var7 - 1).x, var8
                    );
                    double var14 = Class3071.method6022(
                            this.field3807.get(var7).x + this.field3809.x, this.field3807.get(var7).x, var9
                    );
                    double var16 = Class3071.method6022(
                            this.field3807.get(var7 - 1).y + this.field3809.y, this.field3807.get(var7 - 1).y, var8
                    );
                    double var18 = Class3071.method6022(
                            this.field3807.get(var7).y + this.field3809.y, this.field3807.get(var7).y, var9
                    );
                    double var20 = Class3071.method6022(
                            this.field3807.get(var7 - 1).z + this.field3809.z, this.field3807.get(var7 - 1).z, var8
                    );
                    double var22 = Class3071.method6022(
                            this.field3807.get(var7).z + this.field3809.z, this.field3807.get(var7).z, var9
                    );
                    ...
                    this.field3814
                            .ac
                            .method1233(
                                    this.field3807.get(var7 - 1).x,
                                    this.field3807.get(var7 - 1).y,
                                    this.field3807.get(var7 - 1).z,
                                    this.field3807.get(var7).x,
                                    this.field3807.get(var7).y,
                                    this.field3807.get(var7).z,
                                    var10,
                                    var11
                            );
                }
