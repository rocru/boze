...
public class Scaffold extends Module {
   ...
   private dev.boze.client.utils.Timer field3107 = new dev.boze.client.utils.Timer();
   private boolean field3108;
   private dev.boze.client.utils.Timer field3109 = new dev.boze.client.utils.Timer();
   private BlockInteraction field3110;
   private ArrayList<Placement> field3111 = new ArrayList();
   ...
   public void method1765(ACRotationEvent event) {
      if (!event.method1018(this.field3093.method461(), this.field3094.method419())) {
         ...
         if (this.field3107.hasElapsed(this.field3097.getValue() * 50.0)) {
            ...
            double var12 = (double)mc.player.input.movementForward;
            double var14 = (double)mc.player.input.movementSideways;
   ...
   public BlockInteraction method1769(double x, double y, double z, double forward, double strafe, float YAW) {
      ...
      while (var15 == null) {
         ...
         var16 = x
            + (forward * 0.45 * Math.cos(Math.toRadians((double)(YAW + 90.0F))) + strafe * 0.45 * Math.sin(Math.toRadians((double)(YAW + 90.0F)))) * var20;
         var18 = z
            + (forward * 0.45 * Math.sin(Math.toRadians((double)(YAW + 90.0F))) - strafe * 0.45 * Math.cos(Math.toRadians((double)(YAW + 90.0F)))) * var20;
         if (var20 == var22) {
            break;
         }
