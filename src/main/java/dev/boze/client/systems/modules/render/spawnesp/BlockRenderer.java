...
public class BlockRenderer {
    ...
    public void method2029(Render3DEvent event) {
        ...
        int var6 = event.field1950
                .field2170
                .method710(this.field3694, (double) this.field3695 + 0.05, this.field3696)
                .method715(var5)
        ...
        int var7 = event.field1950
                .field2170
                .method710(this.field3694, (double) this.field3695 + 0.05, this.field3696 + 1)
                .method715(var5)
                .method714(var5.method958())
                .method712(var5.method959())
                .method714(var5.method960())
        ...
        int var8 = event.field1950
                .field2170
                .method710(this.field3694 + 1, (double) this.field3695 + 0.05, this.field3696)
                .method715(var5)
                .method714(var5.method958())
                .method712(var5.method959())
                .method714(var5.method960())
        ...
        int var9 = event.field1950
                .field2170
                .method710(this.field3694 + 1, (double) this.field3695 + 0.05, this.field3696 + 1)
                .method715(var5)
                .method714(var5.method958())
                .method712(var5.method959())
                .method714(var5.method960())
