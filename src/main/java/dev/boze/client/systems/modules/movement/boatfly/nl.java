...
public class nl extends nj {
    ...
    private Vec3d method1954() {
        ...
        if (Class5924.method2116()) {
            Vec3d var10 = Class5924.method93(this.field1556.field3152.getValue().floatValue());
            var4 = var10.x;
            var8 = var10.z;
        }
    ...
    private double method2091() {
        ...
        if (mc.options.jumpKey.isPressed()) {
            ...
            return this.field1556.field3153.getValue().floatValue();
        } else if (this.field1556.field3155.getValue().isPressed()) {
            return -this.field1556.field3154.getValue();
    ...
    private void method704(PacketBundleEvent var1) {
        if (var1.packet instanceof PlayerPositionLookS2CPacket var5 && mc.player.isRiding()) {
