...
public class WebTP extends Module {
   ...
   private EnumSetting<WebTPMode> field540 = new EnumSetting<WebTPMode>("Mode", WebTPMode.Strict, "Mode for WebTP");
   private IntSetting field541 = new IntSetting("ShiftTicks", 3, 0, 10, 1, "Amount of ticks to shift per tick while moving through webs");
