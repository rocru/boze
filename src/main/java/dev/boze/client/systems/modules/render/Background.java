...
public class Background extends Module {
    ...
    public void method1896(Render3DEvent event) {
        ...
        Vec3d var6 = this.method1898(mc.gameRenderer.getCamera().getPitch(), mc.gameRenderer.getCamera().getYaw())
        ...
        Vec3d var10 = this.method1898((double) mc.gameRenderer.getCamera().getPitch() - 90.0, mc.gameRenderer.getCamera().getYaw());
        Vec3d var11 = this.method1898((double) mc.gameRenderer.getCamera().getPitch() + 90.0, mc.gameRenderer.getCamera().getYaw());
