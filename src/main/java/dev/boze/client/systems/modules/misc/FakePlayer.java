...
public class FakePlayer extends Module {
    ...
    private void method1708(MovementEvent var1) {
        if (this.gApple.getValue() && this.timer.hasElapsed(this.gAppleDelay.getValue() * 1000.0F)) {
        ...
        if (this.recordPositions.getValue().isPressed() && mc.currentScreen == null) {
            ...
            FakePositions var5 = this.positions.get(this.field2946);
    ...
    private void method1709(PacketBundleEvent var1) {
        if (MinecraftUtils.isClientActive()) {
            if (var1.packet instanceof ExplosionS2CPacket var5) {
                mc.send(() -> lambda$onPacketReceive$0(var5));
            }
        }
    }
    ...
    private void method1710(ExplosionS2CPacket var1) {
        if (mc.world != null && this.fakePlayer != null && this.isEnabled()) {
            ...
            if (!(var12 > 1.0)) {
                ...
                double var15 = Explosion.getExposure(var11, this.fakePlayer);
                double var21;
