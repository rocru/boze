...
public class Breadcrumbs extends Module {
            ...
            if (this.field3423.isEmpty() || !event.field1941.getPos().equals(this.field3423.get(this.field3423.size() - 1))) {
                if (this.field3432 > this.field3425.getValue()) {
                    ...
                    if (!this.field3423.isEmpty()
                            && var5.distanceTo(this.field3423.get(this.field3423.size() - 1)) > 64.0
                    ...
                    } else if (this.field3426.getValue() == BreadcrumbsLimit.Fade) {
    ...
    public void method1912(Render3DEvent event) {
        float[] var5 = Color.RGBtoHSB(this.field3429.getValue().field408, this.field3429.getValue().field409, this.field3429.getValue().field410, null);

        for (int var6 = 0; var6 < this.field3423.size() - 2; var6++) {
            Vec3d var7 = this.field3423.get(var6);
            Vec3d var8 = this.field3423.get(var6 + 1);
            int var9 = this.field3429.getValue().field411;
            int var10 = this.field3429.getValue().field411;
            if (this.field3426.getValue() == BreadcrumbsLimit.Fade) {
                if (!this.field3422.containsKey(var7) || !this.field3422.containsKey(var8)) {
                    return;
                }

                float var11 = (float) (System.currentTimeMillis() - this.field3422.get(var7));
                float var12 = (float) (System.currentTimeMillis() - this.field3422.get(var8));
                if (var11 >= this.field3428.getValue() * 1000.0F) {
                    this.field3423.remove(var7);
                    this.field3422.remove(var7);
                    return;
                }

                var9 = (int) (MathHelper.clamp(1.0F - var11 / (this.field3428.getValue() * 1100.0F), 0.0F, 1.0F) * 255.0F);
                var10 = (int) (MathHelper.clamp(1.0F - var12 / (this.field3428.getValue() * 1100.0F), 0.0F, 1.0F) * 255.0F);
            }

            int var15 = Color.HSBtoRGB(var5[0], var5[1], var5[2]);
            RGBAColor var16 = new RGBAColor(var15 >> 16 & 0xFF, var15 >> 8 & 0xFF, var15 & 0xFF, var9);
            if (this.field3430.getValue()) {
                var5[0] += this.field3431.getValue() * 0.1F;
            }
    ...
    private boolean lambda$new$1() {
        return this.field3426.getValue() == BreadcrumbsLimit.Fade;
    }

    private boolean lambda$new$0() {
        return this.field3426.getValue() == BreadcrumbsLimit.Length;
    }
}
