...
public class ElytraBoost extends Module {
   ...
   private final MinMaxSetting field1005 = new MinMaxSetting("Factor", 1.0, 0.1, 10.0, 0.1, "Boost factor");
   private final MinMaxSetting field1006 = new MinMaxSetting("MaxSpeed", 1.8, 0.1, 10.0, 0.1, "Max speed");
   ...
   private Vec3d method479(Vec3d var1, float var2, float var3) {
      ...
      double var17 = Math.cos((double)var10);
