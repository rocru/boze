...
public class Jesus extends Module {
    ...
    private final BooleanSetting field3284 = new BooleanSetting("Water", true, "Walk on water");
    private final EnumSetting<JesusMode> field3285 = new EnumSetting<JesusMode>("Mode", JesusMode.Normal, "Water jesus mode", this.field3284);
    private final BooleanSetting field3286 = new BooleanSetting("Extinguish", true, "Extinguish fire when walking on water", this.field3284);
    private final BooleanSetting field3287 = new BooleanSetting("Lava", true, "Walk on lava");
    private final EnumSetting<JesusMode> field3288 = new EnumSetting<JesusMode>("Mode", JesusMode.Normal, "Lava jesus mode", this.field3287);
    private final EnumSetting<JesusNoSetback> field3289 = new EnumSetting<JesusNoSetback>(
    ...
    public void onEnable() {
        this.field3295 = BaritoneAPI.getSettings().assumeWalkOnWater.value;
        this.field3296 = BaritoneAPI.getSettings().assumeWalkOnLava.value;
    ...
    private boolean method1843() {
        ...
        for (Box var8 : Streams.stream(mc.world.getBlockCollisions(mc.player, mc.player.getBoundingBox().offset(0.0, -0.5, 0.0)))
    ...
    private boolean method1844() {
        if (this.field3286.getValue() && mc.player.isOnFire()) {
            ...
            return ((this.field3289.getValue() != JesusNoSetback.Water && this.field3289.getValue() != JesusNoSetback.Both)
                    || !(mc.player.fallDistance > (float) this.field3290.getValue().intValue())) && this.field3285.getValue() == JesusMode.Normal;
        }
    }
    ...
    private boolean method1845() {
        if (mc.options.sneakKey.isPressed()) {
            ...
            return ((this.field3289.getValue() != JesusNoSetback.Lava && this.field3289.getValue() != JesusNoSetback.Both)
                    || !(mc.player.fallDistance > (float) this.field3290.getValue().intValue())) && this.field3288.getValue() == JesusMode.Normal;
        }
    }
}
