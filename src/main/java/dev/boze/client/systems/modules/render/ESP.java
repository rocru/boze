...
import dev.boze.client.jumptable.np;
...
public class ESP extends Module {
   ...
   private void method1929(Renderer3D var1, float var2, Entity var3) {
      ...
      if (this.field3499.method461() != BoxDrawMode.Simple && !(var3 instanceof FlyingItemEntity)) {
         ...
         double var13 = MathHelper.lerp((double)var2, var3.lastRenderY, var3.getY()) - var3.getY();
         double var15 = MathHelper.lerp((double)var2, var3.lastRenderZ, var3.getZ()) - var3.getZ();
      ...
      if (this.field3499.method461() == BoxDrawMode.Flat) {
         ...
         for (Entity var6 : mc.world.getEntities()) {
            if (this.method1934(var6)) {
               ...
               double var8 = MathHelper.lerp((double)event.tickDelta, var6.lastRenderX, var6.getX()) - var6.getX();
               double var10 = MathHelper.lerp((double)event.tickDelta, var6.lastRenderY, var6.getY()) - var6.getY();
               double var12 = MathHelper.lerp((double)event.tickDelta, var6.lastRenderZ, var6.getZ()) - var6.getZ();
