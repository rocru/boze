...
public class Path {
    ...
    void method2092(Vec3d var1) {
        this.field3876.add(var1);
    }

    void method2093(double var1, double var3) {
        for (Vec3d var9 : this.field3876) {
            double var10 = 0.0;
            if (!this.field3877.isEmpty()) {
                Vec3d var12 = this.field3877.get(this.field3877.size() - 1);
                var10 -= var12.length();
            }
    ...
    public Vec3d method2094() {
        return this.field3878 >= this.field3877.size() ? null : this.field3877.get(this.field3878++);
    }

    public Vec3d method2095() {
        return this.field3878 >= this.field3877.size() ? null : this.field3877.get(this.field3878 + 1);
    }
