...
public class PathFinder implements IMinecraft {
      ...
      if (!this.field3894) {
         ...
         for (var4 = 0; var4 < this.field3891 && !this.method2116(); var4++) {
            ...
            for (PathPos var6 : this.method2100(this.field3881)) {
               float var7 = (Float)this.field3888.get(this.field3881) + this.method2099(this.field3881, var6);
               if (!this.field3888.containsKey(var6) || !((Float)this.field3888.get(var6) <= var7)) {
   ...
   protected boolean method2106(BlockPos pos) {
      if (!this.method2108(pos, true)) {
         ...
         return !this.method2110(var5) ? false : this.method2111(pos.down());
      }
   }
   ...
   private boolean method2108(BlockPos var1, boolean var2) {
      if (this.field3887.method1478() && var2) {
         ...
         Box var15 = field3879.getBoxAt((double)var1.getX() + 0.5, (double)var1.getY(), (double)var1.getZ() + 0.5);
   ...
   private boolean method2110(BlockPos var1) {
      if (!mc.world.isChunkLoaded(var1)) {
         ...
         if (var5.blocksMovement() && !(var6 instanceof AbstractSignBlock)) {
            ...
            return !(var6 instanceof TripwireBlock) && !(var6 instanceof PressurePlateBlock)
               ? this.method2114() || var6 != Blocks.LAVA && !(var6 instanceof AbstractFireBlock)
               : false;
         }
      }
   }
   ...
   private boolean method2113(PathPos var1) {
      ...
      if (this.field3887.method1477() && this.method2110(var5)) {
         ...
         for (int var7 = 0; var7 <= 3; var7++) {
            ...
            var6 = (BlockPos)this.field3889.get(var6);
         }
   ...
   public ArrayList<PathPos> method2120() {
      if (!this.field3894 && !this.field3895) {
         ...
         while (var4 != null) {
            ...
            var4 = (PathPos)this.field3889.get(var4);
         }
