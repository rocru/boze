...
public class DebugCommand extends Command {
   ...
   private int lambda$build$5(CommandContext var1) throws CommandSyntaxException {
      ...
      String var5 = BozeLogger.method523(Surround.INSTANCE, (long)var4);
      this.method624("Debug log for last " + var4 + " seconds:", new Object[0]);
      this.method624(var5, new Object[0]);
      return 1;
   }

   private int lambda$build$4(CommandContext var1) throws CommandSyntaxException {
      int var4 = IntegerArgumentType.getInteger(var1, "seconds");
      String var5 = BozeLogger.method523(Replenish.INSTANCE, (long)var4);
      this.method624("Debug log for last " + var4 + " seconds:", new Object[0]);
      this.method624(var5, new Object[0]);
      return 1;
   }
   ...
   private int lambda$build$3(CommandContext var1) throws CommandSyntaxException {
      int var4 = IntegerArgumentType.getInteger(var1, "seconds");
      String var5 = BozeLogger.method523(OffHand.INSTANCE, (long)var4);
      this.method624("Debug log for last " + var4 + " seconds:", new Object[0]);
      this.method624(var5, new Object[0]);
      return 1;
   }
