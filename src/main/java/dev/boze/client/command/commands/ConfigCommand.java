...
public class ConfigCommand extends Command {
   ...
   private int lambda$build$11(Category var1, CommandContext var2) throws CommandSyntaxException {
      ...
      this.method624("Exported config for " + var1.name() + " modules to " + var6, new Object[0]);
      return 1;
   }
   ...
   private int lambda$build$10(CommandContext var1) throws CommandSyntaxException {
      ...
      this.method624("Exported config for all modules to " + var5, new Object[0]);
      return 1;
   }
   ...
   private int lambda$build$9(CommandContext var1) throws CommandSyntaxException {
      ...
      this.method624("Exported config for " + var4.internalName + " to " + var5, new Object[0]);
      return 1;
   }
   ...
   private int lambda$build$8(CommandContext var1) throws CommandSyntaxException {
      for (String var8 : ConfigManager.get(ConfigType.CONFIG)) {
         if (Files.getNameWithoutExtension(var8).equalsIgnoreCase((String)var1.getArgument("title", String.class))) {
            ...
            this.method624("Deleted config " + (String)var1.getArgument("title", String.class), new Object[0]);
            return 1;
         }
      }

      this.method626("Config " + (String)var1.getArgument("title", String.class) + " not found", new Object[0]);
      return 1;
   }
   ...
   private void lambda$build$6(String var1) {
      this.method624(" - (highlight)%s", new Object[]{var1});
   }
   ...
   private void lambda$build$4(String[] var1, String var2) {
      ...
      for (String var11 : var1) {
         if (!var11.startsWith("CF")) {
            this.method626("Invalid code " + var11, new Object[0]);
            return;
         }
      ...
      if (!field1386 && var13 == null) {
         ...
         this.method624("Grouped config " + var2 + " has been shared with code " + var13, new Object[0]);
         this.method624("Load it using the command " + Options.method1563() + "load " + var13, new Object[0]);
   ...
   private void lambda$build$2(String var1) {
      for (String var8 : ConfigManager.get(ConfigType.CONFIG)) {
         if (var8.equalsIgnoreCase(var1)) {
            ...
            this.method624("Config " + var1 + " has been shared with code " + var10, new Object[0]);
            this.method624("Load it using the command " + Options.method1563() + "load " + var10, new Object[0]);
   ...
   private int lambda$build$1(CommandContext var1) throws CommandSyntaxException {
      ...
      if (!var5.isEmpty()) {
         this.method624("Configs (%d):", new Object[]{var5.size()});
         var5.forEach(this::lambda$build$0);
      } else {
         this.method624("No configs found", new Object[0]);
      }
