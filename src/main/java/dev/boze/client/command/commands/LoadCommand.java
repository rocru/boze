...
public class LoadCommand extends Command {
   ...
   private void method632(String var1, NbtCompound var2) {
      ...
      if (var6 == null) {
         this.method626("Invalid config " + var1, new Object[0]);
      } else {
         ...
         if (!var7.isEmpty()) {
            this.method624("Loaded config " + var1 + " for:", new Object[0]);
   ...
   private int lambda$build$1(CommandContext var1) throws CommandSyntaxException {
      ...
      if (var5.length() != 10) {
         ...
         if (var6.equals("PR")) {
            ...
            if (var15 == null) {
               this.method626("Invalid code " + var5, new Object[0]);
               return 1;
            } else if (var15.contains("ProfileName")) {
               Class1201.method2383(true);
               String var17 = var15.getString("ProfileName");
               this.method625("(highlight)" + var17 + "(default) is a legacy profile, splitting into 4 profiles", new Object[0]);
               ...
               for (Setting var13 : Profiles.INSTANCE.method1144()) {
                  if (var13 instanceof CurrentProfileSetting var14 && var14.field969.equals(var20)) {
                     if (var14.field968.contains(var11)) {
                        this.method625(
                           "Loading profile as (highlight)" + var5 + "(default) since profile (highlight)" + var18 + "(default) already exists", new Object[0]
                        );
                        var18 = var5;
                        var11 = var20 + var5;
                     }
                     ...
                     this.method624("Loaded profile (highlight)" + var18, new Object[0]);
                     return 1;
                  }
               }

               this.method626("Error loading profile (highlight)" + var18, new Object[0]);
               return 1;
            } else {
               this.method626("Unrecognized profile version " + var5, new Object[0]);
               return 1;
            }
         } else {
            if (var6.equals("CF")) {
