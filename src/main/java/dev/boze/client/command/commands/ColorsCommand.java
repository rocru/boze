...
public class ColorsCommand extends Command {
   ...
   private void method628(String var1, Class5903<?> var2) {
      this.method624(" - (highlight)%s (default)%s", new Object[]{var1, var2.toString()});
   }
   ...
   private int lambda$build$4(CommandContext var1) throws CommandSyntaxException {
      ...
      if (Colors.INSTANCE.field2343.containsKey(var5)) {
         this.method626("Color (highlight)%s(default) already exists", new Object[]{var5});
         return 1;
      } else {
         ...
         if (var12.length % 3 == 0 && var12.length >= 6 && var13.exists()) {
            ...
            for (int var15 = 0; var15 < var12.length; var15++) {
               try {
                  ...
                  this.method626("Invalid color format. Please check the System > Colors docs.", new Object[0]);
                  return 1;
               }
            }
            ...
            this.method624("Added color (highlight)%s (default)%s", new Object[]{var5, var19.toString()});
            return 1;
         } else {
            this.method626("Invalid color format. Please check the System > Colors docs.", new Object[0]);
            return 1;
   ...
   private int lambda$build$3(CommandContext var1) throws CommandSyntaxException {
      ...
      if (Colors.INSTANCE.field2343.containsKey(var5)) {
         ...
         if (var9.length % 3 == 0 && var9.length >= 6 && var10.exists()) {
            ...
            this.method624("Added color (highlight)%s (default)%s", new Object[]{var5, var15.toString()});
            return 1;
         } else {
            this.method626("Invalid color format. Please check the System > Colors docs.", new Object[0]);
            return 1;
   ...
   private int lambda$build$2(CommandContext var1) throws CommandSyntaxException {
      ...
      if (Colors.INSTANCE.field2343.containsKey(var5)) {
         ...
         this.method624("Added color (highlight)%s (default)%s", new Object[]{var5, var9.toString()});
         return 1;
      }
   }
   ...
   private int lambda$build$1(CommandContext var1) throws CommandSyntaxException {
      ...
      if (Colors.INSTANCE.method1335(var5)) {
         this.method624("Deleted color (highlight)%s", new Object[]{var5});
      } else {
         this.method626("Could not delete color (highlight)%s, as it does not exist", new Object[]{var5});
      }
   ...
   private int lambda$build$0(CommandContext var1) throws CommandSyntaxException {
      ...
      if (!var5.isEmpty()) {
         this.method624("Colors (%d):", new Object[]{var5.size()});
         var5.forEach(this::method628);
      } else {
         this.method624("No custom colors", new Object[0]);
      }
