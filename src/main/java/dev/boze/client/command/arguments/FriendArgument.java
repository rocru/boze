...
public class FriendArgument implements ArgumentType<Class3063> {
   private static final Collection<String> field1859 = (Collection<String>)Friends.method2120()
      .stream()
      .limit(3L)
   ...
   public static Class3063 method995(CommandContext<?> context, String name) {
      return (Class3063)context.getArgument(name, Class3063.class);
   }

   public Class3063 method996(StringReader reader) throws CommandSyntaxException {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
      return CommandSource.suggestMatching((Iterable)Friends.method2120().stream().map(Class3063::method5992).collect(Collectors.toList()), builder);
   }
