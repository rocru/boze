...
class EnumArgument implements ArgumentType<Enum> {
   ...
   public Enum method992(StringReader reader) {
   ...
   public static Enum method993(CommandContext<?> context, String name) {
      return (Enum)context.getArgument(name, Enum.class);
   }

   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
      ArrayList var6 = new ArrayList();

      for (Enum var10 : (Enum[])this.field1858.field972.getClass().getEnumConstants()) {
   ...
   public Collection<String> getExamples() {
      ...
      for (Enum var8 : (Enum[])this.field1858.field972.getClass().getEnumConstants()) {
