...
public class ProfileListArgument implements ArgumentType<String> {
   ...
   private Set<String> method1013() {
      return (Set<String>)this.field1867.field968.stream().map(ProfileListArgument::lambda$getProfiles$1).collect(Collectors.toUnmodifiableSet());
   }
   ...
   public String method1015(StringReader reader) throws CommandSyntaxException {
   ...
   public Collection<String> getExamples() {
      return (Collection<String>)this.method1013().stream().limit(3L).collect(Collectors.toList());
   }
