...
public class ConfigArgument implements ArgumentType<String> {
   ...
   private ConfigArgument() {
      ...
      field1856 = (Collection<String>)field1855.stream().limit(3L).collect(Collectors.toList());
   }
   ...
   public String method991(StringReader reader) throws CommandSyntaxException {
