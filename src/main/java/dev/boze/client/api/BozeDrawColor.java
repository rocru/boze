...
public class BozeDrawColor extends RGBAColor implements DrawColor {
   ...
   public BozeDrawColor method961(RGBAColor value) {
      super.method198(value);
   ...
   public BozeDrawColor method962(double factor) {
   ...
   public BozeDrawColor method963(double factor) {
   ...
   public BozeDrawColor method964() {
      return new BozeDrawColor(
         this.field408,
         this.field409,
         this.field410,
         ...
         this.field1843,
         this.field1844,
         (double[])this.field1845.clone(),
         (double[])this.field1846.clone()
      );
   }
   ...
   public DrawColor method965(JsonObject object) {
   ...
   // $VF: bridge method
   @Override
   public RGBAColor method201(NbtCompound nbtCompound) {
   ...
   // $VF: bridge method
   @Override
   public RGBAColor method198(RGBAColor arg) {
      return this.method961(arg);
   }
