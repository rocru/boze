...
public class Class3032 implements IMinecraft {
    ...
    public static float method5931(String var0) {
        return field133.getOrDefault(var0, 0.0F);
    }
    ...
    public static void method332(DrawContext var0) {
        method2142();
        Collection<GradientColor> var4 = GradientColor.field420.values();
        int var5 = var4.size();
        if (var5 != 0) {
            ...
            for (GradientColor var17 : var4) {
                method5935(var17.field424 ? RenderUtil.field3966 : RenderUtil.field3963, var17, 0.0, var12, mc.getWindow().getScaledWidth(), var8);
    ...
    public static void method5935(RenderUtil var0, GradientColor var1, double var2, double var4, double var6, double var8) {
        ...
        for (var19 = 0; var19 < var17; var19++) {
            var18[var19] = var1.field422.get(var19);
        }

        float var20 = var1.field428;
        if (var1.field425) {
            for (int var21 = var17 - 2; var19 < var18.length; var19++) {
                var18[var19] = var1.field422.get(var21--);
            }
        } else {
            var18[var17] = var1.field422.get(0);
