...
class Class5941 {
    ...
    HashMap<String, byte[]> method11524(String v1, String v2) {
        ...
        label456:
        {
            ...
            try {
                ...
                HotSpotDiagnosticMXBean var84 = ManagementFactory.getPlatformMXBean(HotSpotDiagnosticMXBean.class);
    ...
    private String method11529() {
        ...
        if (!var6038) {
            if (!var10000) {
                throw new IOException("\"" + var6040.getAbsolutePath() + "\" does not exist or is not a directory!");
            }
