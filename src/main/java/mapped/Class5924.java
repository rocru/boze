...
public class Class5924 implements IMinecraft {
    ...
    public static HitResult method73(double var0, RotationHelper var2, boolean var3) {
        ...
        if (var7 == null) {
            ...
            HitResult var10 = var3 ? null : var7.raycast(var0, 1.0F, false);
            Vec3d var11 = var7.getCameraPosVec(1.0F);
            boolean var12 = var8 > 3.0;
    ...
    public static List<BlockPos> method348(Vec3d var0) {
        ...
        for (int var14 = 1; var14 < var10 + 1; var14++) {
            var5.add(method81(var4, var14, 0.0, 1 + var12));
            var5.add(method81(var4, var14, 0.0, -(1 + var13)));
        }

        for (int var15 = 0; var15 <= var11; var15++) {
            var5.add(method81(var4, -var15, 0.0, 1 + var12));
            var5.add(method81(var4, -var15, 0.0, -(1 + var13)));
        }

        for (int var16 = 1; var16 < var12 + 1; var16++) {
            var5.add(method81(var4, 1 + var10, 0.0, var16));
            var5.add(method81(var4, -(1 + var11), 0.0, var16));
        }

        for (int var17 = 0; var17 <= var13; var17++) {
            var5.add(method81(var4, 1 + var10, 0.0, -var17));
            var5.add(method81(var4, -(1 + var11), 0.0, -var17));
        }
    ...
    public static boolean method1934(Entity var0) {
        return var0 == null || var0.getPos().equals(new Vec3d(var0.prevX, var0.prevY, var0.prevZ));
    }
    ...
    public static Vec3d method94(double var0, boolean var2) {
        double var10 = mc.player.input.movementForward;
        if (var10 <= 0.0 && var2) {
            var10 = 1.0;
        }
        ...
        double var12 = mc.player.input.movementSideways;
        ...
        if (var10 == 0.0 && var12 == 0.0) {
            ...
            var6 = var10 * var0 * Math.cos(Math.toRadians(var14 + 90.0F)) + var12 * var0 * Math.sin(Math.toRadians(var14 + 90.0F));
            var8 = var10 * var0 * Math.sin(Math.toRadians(var14 + 90.0F)) - var12 * var0 * Math.cos(Math.toRadians(var14 + 90.0F));
        }
    ...
    public static double method97(Vec2f var0) {
        return Math.toDegrees(Math.atan2(var0.y, var0.x)) - 90.0;
    }
