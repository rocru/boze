...
public class Class5942 {
   ...
   private static String method11539() {
      JsonObject var2 = method11541("https://boze.dev/webfiles/servers.json");
      HashMap var3 = new HashMap();
      var3.put("best", "NONE");
      AtomicLong var4 = new AtomicLong(999L);
      var2.keySet().forEach(Class5942::lambda$requestBestServer$0);
      return var2.get((String)var3.get("best")).getAsString();
   }
   ...
   private static void lambda$requestBestServer$0(JsonObject var0, HashMap var1, AtomicLong var2, String var3) {
      ...
      label45: {
         ...
         int var12 = ((String)var1.get("best")).equals("NONE");
         if (!var6) {
            if (var12 == 0) {
